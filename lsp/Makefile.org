...
\subsubsection{Temporary File msg fix}
...
#+end_src
\subsection{The GCL-2.6.9 stanza}
This stanza will be written when the GCLVERSION variable is
...
#+end_src
\subsection{The GCL-2.6.10 stanza}
This stanza will be written when the GCLVERSION variable is
...
#+end_src
\subsection{The GCL-2.6.11 stanza}
This stanza will be written when the GCLVERSION variable is
...
\subsection{The GCL-2.6.12 stanza}
This stanza will be written when the GCLVERSION variable is
...
\subsection{The GCL-2.6.13pre stanza}
This stanza will be written when the GCLVERSION variable is
