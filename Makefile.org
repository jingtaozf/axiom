...
1. src/scripts -- building scripts
1. src/lib     -- building lib files
1. lsp       -- building gcl common lisp
1. src       -- building src
1. src/interp  -- building interpreter files
1. src/share   -- building share files
1. src/algebra -- building help files
1. src/algebra -- building input files
1. src/algebra -- building xhtml files
1. src/algebra -- building algebra files
...
1. src/etc   -- building etc
1. src/doc   -- building doc files
1. src/input -- running regression tests
