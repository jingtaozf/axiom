...
--S 1 of 460
t0300:= 1/x/cos(a+b*log(c*x^n))^(5/2)
--R 
--R
--R                               1
--R   (1)  ----------------------------------------------
...
--R        ++                             +---------------------+
--R                              n      2 |              n
--R             %R cos(b log(c %R ) + a) \|cos(b log(c %R ) + a)
...
--S 12 of 460
r0302:= -2*cos(a+b*log(c*x^n))^(1/2)*EllipticE(1/2*a+1/2*b*log(c*x^n),2)*_
...
--S 17 of 460
r0303:= 2/3*cos(a+b*log(c*x^n))^(1/2)*EllipticF(1/2*a+1/2*b*log(c*x^n),2)*_
...
--S 27 of 460
r0305:= 2/3*cos(a+b*log(c*x^n))^(1/2)*EllipticF(1/2*a+_
...
--S 32 of 460
r0306:= 6/5*cos(a+b*log(c*x^n))^(1/2)*EllipticE(1/2*a+_
        1/2*b*log(c*x^n),2)*sec(a+b*log(c*x^n))^(1/2)/b/n+_
...
--S 42 of 460
r0308:= -2*cos(a+b*log(c*x^n))*csc(a+b*log(c*x^n))^(1/2)/b/n-_
...
--S 47 of 460
r0309:= -2/3*cos(a+b*log(c*x^n))*csc(a+b*log(c*x^n))^(3/2)/b/n+_
...
--S 57 of 460
r0311:= -2/3*cos(a+b*log(c*x^n))/b/n/csc(a+b*log(c*x^n))^(1/2)+_
        2/3*csc(a+b*log(c*x^n))^(1/2)*EllipticF(1/2*a-1/4*%pi+_
        1/2*b*log(c*x^n),2)*sin(a+b*log(c*x^n))^(1/2)/b/n
--R 
--R   There are no library operations named EllipticF 
...
--S 62 of 460
r0312:= -2/5*cos(a+b*log(c*x^n))/b/n/csc(a+b*log(c*x^n))^(3/2)+_
...
--R  /
--R     b n cosh(b n log(x) + b log(c) + a)
--R                                         Type: Union(Expression(Integer),...)
--E 73
...
--R     + 
--R                                                 n
--R       - b cosh(b n log(x) + b log(c) + a)log(c x )
--R     + 
--R       (b n log(x) + 1)cosh(b n log(x) + b log(c) + a)
--R  /
--R     b n cosh(b n log(x) + b log(c) + a)
...
--R     + 
--R        n                               2
--R       x sinh(b n log(x) + b log(c) + a)
--R  /
--R        n                               2
--R     x x cosh(b n log(x) + b log(c) + a)
--R                                                    Type: Expression(Integer)
--E 75
...
--R  /
--R     b n sinh(b n log(x) + b log(c) + a)
--R                                         Type: Union(Expression(Integer),...)
--E 78
...
--R     + 
--R                   n
--R       (- b log(c x ) + b n log(x) + 1)sinh(b n log(x) + b log(c) + a)
--R     + 
--R       - cosh(b n log(x) + b log(c) + a)
--R  /
--R     b n sinh(b n log(x) + b log(c) + a)
...
--R     + 
--R        n                               2
--R       x cosh(b n log(x) + b log(c) + a)
--R  /
--R        n                               2
--R     x x sinh(b n log(x) + b log(c) + a)
--R                                                    Type: Expression(Integer)
--E 80
...
--S 87 of 460
r0317:= 2/3*%i*EllipticF(-1/4*%pi+1/2*%i*(a+b*log(c*x^n)),2)*_
...
--S 92 of 460
r0318:= 6/5*%i*EllipticE(-1/4*%pi+1/2*%i*(a+b*log(c*x^n)),2)*_
...
--S 102 of 460
r0320:= -2*cosh(a+b*log(c*x^n))/b/n/sinh(a+b*log(c*x^n))^(1/2)-_
...
--S 107 of 460
r0321:= -2/3*cosh(a+b*log(c*x^n))/b/n/sinh(a+b*log(c*x^n))^(3/2)+_
...
--S 147 of 460
r0329:= 2*%i*cosh(a+b*log(c*x^n))^(1/2)*_
...
--S 152 of 460
r0330:= -2/3*%i*cosh(a+b*log(c*x^n))^(1/2)*_
...
--S 162 of 460
r0332:= -2/3*%i*cosh(a+b*log(c*x^n))^(1/2)*_
        EllipticF(1/2*%i*(a+b*log(c*x^n)),2)*sech(a+b*log(c*x^n))^(1/2)/b/n+_
        2/3*sinh(a+b*log(c*x^n))/b/n/sech(a+b*log(c*x^n))^(1/2)
--R 
--R   There are no library operations named EllipticF 
--R      Use HyperDoc Browse or issue
--R                             )what op EllipticF
...
--S 167 of 460
r0333:= -6/5*%i*cosh(a+b*log(c*x^n))^(1/2)*_
        EllipticE(1/2*%i*(a+b*log(c*x^n)),2)*sech(a+b*log(c*x^n))^(1/2)/b/n+_
...
--S 172 of 460
r0334:= -2*%i*csch(a+b*log(c*x^n))^(1/2)*_
...
--S 177 of 460
r0335:= -2*cosh(a+b*log(c*x^n))*csch(a+b*log(c*x^n))^(1/2)/b/n-_
...
--S 182 of 460
r0336:= -2/3*cosh(a+b*log(c*x^n))*csch(a+b*log(c*x^n))^(3/2)/b/n+_
...
--S 192 of 460
r0338:= 2/3*cosh(a+b*log(c*x^n))/b/n/csch(a+b*log(c*x^n))^(1/2)+_
        2/3*%i*csch(a+b*log(c*x^n))^(1/2)*EllipticF(-1/4*%pi+_
        1/2*%i*(a+b*log(c*x^n)),2)*(%i*sinh(a+b*log(c*x^n)))^(1/2)/b/n
--R 
--R   There are no library operations named EllipticF 
...
--S 197 of 460
r0339:= 2/5*cosh(a+b*log(c*x^n))/b/n/csch(a+b*log(c*x^n))^(3/2)+_
...
--R     + 
--R                                                                n
--R       (((- b n - b)x - a n - a)log(b x + a) + b x + a)(b x + a)
--R  /
--R     (b n + b)x + a n + a
--R                                                    Type: Expression(Integer)
--E 235
...
--S 237 of 460
r0347:= -log((b*c-a*d)/b/(c+d*x))*log((a+b*x)/(c+d*x))+_
...
--S 242 of 460
r0348:= -log((b*c-a*d)/b/(c+d*x))*log((a+b*x)/(c+d*x))^2+_
        log(-(b*c-a*d)*x/a/(c+d*x))*log((a+b*x)/(c+d*x))^2-_
        2*log((a+b*x)/(c+d*x))*polylog(2,d*(x+a/b)/(c+d*x))+_
...
--S 252 of 460
r0350:= -1/b/(1+m)*(p*x^m*(b*x)^(-m)*Ei((1+m)*log(b*x))-_
...
--S 257 of 460
r0351:= 1/(1+m)*x^(1+m)*(-p*Ei((1+m)/n*log(b*x^n))*(b*x^n)^(-(1+m)/n)+_
        log(a*log(b*x^n)^p))
--R 
--R
--R                                                - m - 1
...
--S 267 of 460
r0353:= -1/2*(2*a-b)*exp(1)^(a/b)*%pi^(1/2)*erf((a-b*log(x))^(1/2)/_
...
--S 277 of 460
r0355:= -1/2*(2*A*b+(2*a-b)*B)*exp(1)^(a/b)*%pi^(1/2)*_
...
--R                       -           +--------------+
--R                       b +---+    \|- b log(x) + a          +-+ +--------------+
--R   ((B - 2A)b - 2B a)%e \|%pi erf(-----------------) - 2B x\|b \|- b log(x) + a
--R                                          +-+
--R                                         \|b
--R   -----------------------------------------------------------------------------
--R                                          +-+
...
--S 287 of 460
r0357:= -1/4*(2*b*x-Ci(2*b*x)*sin(2*a)-2*log(x)*b*x+2*log(x)*cos(a+b*x)*_
...
--S 292 of 460
r0358:= 1/12*(9*cos(a)*Ci(b*x)-cos(3*a)*Ci(3*b*x)-12*log(x)*cos(a+b*x)+_
...
--R     + 
--R                   3
--R     (4cos(b x + a)  - 12cos(b x + a))log(x) - Ci(3b x)cos(3a) + 9Ci(b x)cos(a)
--R  /
--R     12b
--R                                                    Type: Expression(Integer)
--E 292
...
--S 302 of 460
r0360:= 1/4*(-2*b*x-Ci(2*b*x)*sin(2*a)+2*log(x)*b*x+2*log(x)*cos(a+b*x)*_
        sin(a+b*x)-cos(2*a)*Si(2*b*x))/b
--R 
--R
--R   (2)
...
--S 307 of 460
r0361:= -1/12*(9*Ci(b*x)*sin(a)+Ci(3*b*x)*sin(3*a)-8*log(x)*sin(a+b*x)-_
...
--R     + 
--R       - Si(3b x)cos(3a) - 9Si(b x)cos(a)
--R  /
--R     12b
--R                                                    Type: Expression(Integer)
--E 307
...
--S 327 of 460
r0365:= 1/12/b*(-9*Chi(b*x)*sinh(a)-Chi(3*b*x)*sinh(3*a)+8*log(x)*_
...
--S 332 of 460
r0366:= -4/3*(4+x^2)^(1/2)-1/9*(4+x^2)^(3/2)+8/3*atanh(1/2*(4+x^2)^(1/2))+_
        1/3*(4+x^2)^(3/2)*log(x)
--R 
--R
--R                 +------+
...
--R                                                      +------+
--R             5      3                 5      3        | 2
--R       ((- 3x  - 21x  - 36x)log(x) + x  + 19x  + 48x)\|x  + 4
--R     + 
--R          6      4      2                6      4      2
--R       (3x  + 27x  + 72x  + 48)log(x) - x  - 21x  - 84x  - 64
--R  /
--R               +------+
--R        2      | 2          3
--R     (9x  + 9)\|x  + 4  - 9x  - 27x
...
--S 352 of 460
r0370:= 1/4*x+1/4*%i*x^2-1/2*x*log(1-exp(1)^(2*%i*x))+_
...
--S 357 of 460
r0371:= -2/3*atanh(cos(x))+2/3*cos(x)-1/9*cos(x)^3-_
...
--S 362 of 460
r0372:= 1/3*%i*x^(3/2)-x*log(1-exp(2*%i*x^(1/2)))+x*log(sin(x^(1/2)))+_
...
--R         + 
--R                     4          2           2         2
--R           ((- cos(x)  + 2cos(x)  - 1)cot(x)  + cos(x)  - 1)sin(x)
--R      *
--R         log(sin(x))
--R     + 
--R              2           3
...
--R     + 
--R              5          3
--R       (cos(x)  - 2cos(x)  + cos(x))cot(x)
--R  /
--R            4          2
--R     (cos(x)  - 2cos(x)  + 1)sin(x)
--R                                                    Type: Expression(Integer)
--E 370
...
--S 372 of 460
r0374:= 1/2*(1-b/(b^2-4*a*c)^(1/2))*log(x)*_
        log((b-(b^2-4*a*c)^(1/2)+2*c*x)/(b-(b^2-4*a*c)^(1/2)))/c+_
        1/2*(1+b/(b^2-4*a*c)^(1/2))*log(x)*log((b+(b^2-_
        4*a*c)^(1/2)+2*c*x)/(b+(b^2-4*a*c)^(1/2)))/c+_
        1/2*(1-b/(b^2-4*a*c)^(1/2))*_
        polylog(2,1-(b-(b^2-4*a*c)^(1/2)+2*c*x)/(b-(b^2-4*a*c)^(1/2)))/c+_
        1/2*(1+b/(b^2-4*a*c)^(1/2))*_
...
--S 377 of 460
r0375:= -x/c+x*log(x)/c+1/4*(b-(b^2-4*a*c)^(1/2))^2*log(x)*_
        log((b-(b^2-4*a*c)^(1/2)+2*c*x)/(b-(b^2-4*a*c)^(1/2)))/c^2/_
        (b^2-4*a*c)^(1/2)-1/4*(b+(b^2-4*a*c)^(1/2))^2*log(x)*_
        log((b+(b^2-4*a*c)^(1/2)+2*c*x)/(b+(b^2-4*a*c)^(1/2)))/c^2/_
        (b^2-4*a*c)^(1/2)+1/4*(b-(b^2-4*a*c)^(1/2))^2*_
        polylog(2,1-(b-(b^2-4*a*c)^(1/2)+2*c*x)/(b-(b^2-4*a*c)^(1/2)))/_
        c^2/(b^2-4*a*c)^(1/2)-1/4*(b+(b^2-4*a*c)^(1/2))^2*_
        polylog(2,1-(b+(b^2-4*a*c)^(1/2)+2*c*x)/(b+(b^2-4*a*c)^(1/2)))/_
        c^2/(b^2-4*a*c)^(1/2)
--R 
--R   There are no library operations named polylog 
...
--S 382 of 460
r0376:= -2*c/(b^2-4*a*c)^(1/2)/(b-(b^2-4*a*c)^(1/2))/x+_
        2*c/(b^2-4*a*c)^(1/2)/(b+(b^2-4*a*c)^(1/2))/x-2*c*log(x)/_
        (b^2-4*a*c)^(1/2)/(b-(b^2-4*a*c)^(1/2))/x+_
        2*c*log(x)/(b^2-4*a*c)^(1/2)/(b+(b^2-4*a*c)^(1/2))/x-_
        2*c^2*log(x)^2/(b^2-4*a*c)^(1/2)/(b-(b^2-4*a*c)^(1/2))^2+_
        2*c^2*log(x)^2/(b^2-4*a*c)^(1/2)/(b+(b^2-4*a*c)^(1/2))^2+_
        4*c^2*log(x)*log((b-(b^2-4*a*c)^(1/2)+2*c*x)/_
        (b-(b^2-4*a*c)^(1/2)))/(b^2-4*a*c)^(1/2)/(b-(b^2-4*a*c)^(1/2))^2-_
        4*c^2*log(x)*log((b+(b^2-4*a*c)^(1/2)+2*c*x)/_
        (b+(b^2-4*a*c)^(1/2)))/(b^2-4*a*c)^(1/2)/(b+(b^2-4*a*c)^(1/2))^2+_
...
--R       - x x     (b log(a x ) )
--R     + 
--R                  n - 1       n        n m - 1          n m p - 1
--R       - b m p x x     log(a x )log(a x )     (b log(a x ) )
--R     + 
--R                 n  m p log(n log(x) + log(a)) + p log(b)
--R       (m p + 1)x %e
--R  /
--R                 n
--R     (m p + 1)x x
...
--S 417 of 460
r0383:= -1/2*2^(1/2)*%pi^(1/2)*x*erf(1/2*(-log(a*x^2))^(1/2)*2^(1/2))/_
        (a*x^2)^(1/2)
--R 
--R
--R                              +-----------+
...
--S 442 of 460
r0388:= -1/(1+x)-atan(x)+1/2*log(1-x)+1/2*log(1+x)-_
