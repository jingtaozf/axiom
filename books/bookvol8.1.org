...
1. [1] *random*
  ...
  3. [1.3] *non-gaussian*
2. [2] *determinate*
  4. [2.1] *algebraic* -- A polynomial is defined as a summation of terms
...
$p/q$, where $p$ and $q$ are integers.
    2. [2.1.2] *rational* -- A rational function of $x$ is a quotient of two
polynomials in $x$, both having only integer powers.
      1. [2.1.2.1] *polynomial*
      2. [2.1.2.2] *non-polynomial*
  5. [2.2] *integral* -- Certain continuous functions are not expressible
...
Fresnel integrals, and the error function.
  6. [2.3] *transcendental* -- The transcendental curves cannot be
...
logarithmic ($\log(x)$), or trigonometric ($\sin(x)$, $\cos(x)$). 
    3. [2.3.1] *exponential*
    4. [2.3.2] *logarithmic*
    5. [2.3.3] *trigonometric*
  7. [2.4] *piecewise continuous* -- Other curves, except at a few
