...
\chapter{General examples}
These examples come from code that ships with Axiom in various
input files.

\section{Two dimensional functions}

\subsection{A Simple Sine Function}
{[[ps/v81equation123.eps]]}
#+NAME: equation123
#+begin_src common-lisp :noweb yes
draw(sin(11*x),x = 0..2*%pi)
#+end_src

\subsection{A Simple Sine Function, Non-adaptive plot}
{[[ps/v81equation124.eps]]}
#+NAME: equation124
#+begin_src common-lisp :noweb yes
draw(sin(11*x),x = 0..2*%pi,adaptive == false,title == "Non-adaptive plot")
#+end_src

\subsection{A Simple Sine Function, Drawn to Scale}
{[[ps/v81equation125.eps]]}
#+NAME: equation125
#+begin_src common-lisp :noweb yes
draw(sin(11*x),x = 0..2*%pi,toScale == true,title == "Drawn to scale")
#+end_src

\subsection{A Simple Sine Function, Polar Plot}
{[[ps/v81equation126.eps]]}
#+NAME: equation126
#+begin_src common-lisp :noweb yes
draw(sin(11*x),x = 0..2*%pi,coordinates == polar,title == "Polar plot")
#+end_src

\subsection{A Simple Tangent Function, Clipping On}
{[[ps/v81equation127.eps]]}
#+NAME: equation127
#+begin_src common-lisp :noweb yes
...
\subsection{A Simple Tangent Function, Clipping On}
{[[ps/v81equation128.eps]]}
#+NAME: equation128
#+begin_src common-lisp :noweb yes
draw(tan x,x = -6..6,clip == false,title == "Clipping off")
#+end_src

\subsection{Tangent and Sine}
{[[ps/v81equation101.eps]]}
#+NAME: equation101
#+begin_src common-lisp :noweb yes
...
\subsection{A 2D Sine Function in BiPolar Coordinates}
{[[ps/v81equation107.eps]]}
#+NAME: equation107
#+begin_src common-lisp :noweb yes
draw(sin(x),x=0.5..%pi,coordinates == bipolar(1$DFLOAT))
#+end_src

\subsection{A 2D Sine Function in Elliptic Coordinates}
{[[ps/v81equation110.eps]]}
#+NAME: equation110
#+begin_src common-lisp :noweb yes
draw(sin(4*t/7),t=0..14*%pi,coordinates == elliptic(1$DFLOAT))
#+end_src

\subsection{A 2D Sine Wave in Polar Coordinates}
{[[ps/v81equation118.eps]]}
#+NAME: equation118
#+begin_src common-lisp :noweb yes
draw(sin(4*t/7),t=0..14*%pi,coordinates == polar)
#+end_src

\section{Two dimensional curves}

\subsection{A Line in Parabolic Coordinates}
{[[ps/v81equation114.eps]]}
#+NAME: equation114
#+begin_src common-lisp :noweb yes
...
\subsection{A Parametric Curve}
{[[ps/v81equation129.eps]]}
#+NAME: equation129
#+begin_src common-lisp :noweb yes
draw(curve(sin(5*t),t),t = 0..2*%pi,title == "Parametric curve")
#+end_src

\subsection{A Parametric Curve in Polar Coordinates}
{[[ps/v81equation130.eps]]}
#+NAME: equation130
#+begin_src common-lisp :noweb yes
...
\section{Three dimensional functions}

\subsection{A 3D Constant Function in Elliptic Coordinates}
{[[ps/v81equation111.eps]]}
#+NAME: equation111
#+begin_src common-lisp :noweb yes
...
\subsection{A 3D Constant Function in Oblate Spheroidal}
{[[ps/v81equation113.eps]]}
#+NAME: equation113
#+begin_src common-lisp :noweb yes
m(u:DFLOAT,v:DFLOAT):DFLOAT == 1
...
\subsection{A 3D Constant in Polar Coordinates}
{[[ps/v81equation119.eps]]}
#+NAME: equation119
#+begin_src common-lisp :noweb yes
m(u:DFLOAT,v:DFLOAT):DFLOAT == 1
...
\subsection{A 3D Constant in Prolate Spheroidal Coordinates}
{[[ps/v81equation120.eps]]}
#+NAME: equation120
#+begin_src common-lisp :noweb yes
m(u:DFLOAT,v:DFLOAT):DFLOAT == 1
...
\subsection{A 3D Constant in Spherical Coordinates}
{[[ps/v81equation121.eps]]}
#+NAME: equation121
#+begin_src common-lisp :noweb yes
m(u:DFLOAT,v:DFLOAT):DFLOAT == 1
...
\subsection{A 2-Equation Space Function}
{[[ps/v81equation104.eps]]}
#+NAME: equation104
#+begin_src common-lisp :noweb yes
...
\section{Three dimensional curves}

\subsection{A Parametric Space Curve}
{[[ps/v81equation131.eps]]}
#+NAME: equation131
#+begin_src common-lisp :noweb yes
...
\subsection{A Tube around a Parametric Space Curve}
{[[ps/v81equation132.eps]]}
#+NAME: equation132
#+begin_src common-lisp :noweb yes
draw(curve(sin(t)*cos(3*t/5),cos(t)*cos(3*t/5),cos(t)*sin(3*t/5)),_
...
\subsection{A 2-Equation Cylindrical Curve}
{[[ps/v81equation109.eps]]}
#+NAME: equation109
#+begin_src common-lisp :noweb yes
...
\section{Three dimensional surfaces}

\subsection{A Icosahedron}
{[[ps/v81icosahedron.eps]]}
#+NAME: Icosahedron
#+begin_src common-lisp :noweb yes
...
\subsection{A 3D figure 8 immersion (Klein bagel)}
{[[ps/v81kleinbagel.eps]]}
#+NAME: kleinbagel
#+begin_src common-lisp :noweb yes
r := 1
...
\subsection{A 2-Equation bipolarCylindrical Surface}
{[[ps/v81equation108.eps]]}
#+NAME: equation108
#+begin_src common-lisp :noweb yes
...
\subsection{A 3-Equation Parametric Space Surface}
{[[ps/v81equation105.eps]]}
#+NAME: equation105
#+begin_src common-lisp :noweb yes
...
\subsection{A 3D Vector of Points in Elliptic Cylindrical}
{[[ps/v81equation112.eps]]}
#+NAME: equation112
#+begin_src common-lisp :noweb yes
...
\subsection{A 3D Constant Function in BiPolar Coordinates}
{[[ps/v81equation106.eps]]}
#+NAME: equation106
#+begin_src common-lisp :noweb yes
m(u:DFLOAT,v:DFLOAT):DFLOAT == 1
...
\subsection{A Swept in Parabolic Coordinates}
{[[ps/v81equation115.eps]]}
#+NAME: equation115
#+begin_src common-lisp :noweb yes
draw(surface(u*cos(v),u*sin(v),2*u),u=0..4,v=0..2*%pi,coordinates==parabolic)
#+end_src

\subsection{A Swept Cone in Parabolic Cylindrical Coordinates}
{[[ps/v81equation116.eps]]}
#+NAME: equation116
#+begin_src common-lisp :noweb yes
...
\subsection{A Truncated Cone in Toroidal Coordinates}
{[[ps/v81equation122.eps]]}
#+NAME: equation122
#+begin_src common-lisp :noweb yes
...
\subsection{A Swept Surface in Paraboloidal Coordinates}
{[[ps/v81equation117.eps]]}
#+NAME: equation117
#+begin_src common-lisp :noweb yes
...
\chapter{Jenks Book images}
\subsection{The Complex Gamma Function}
{[[ps/v81complexgamma.eps]]}
#+NAME: complexgamma
#+begin_src common-lisp :noweb yes
...
\subsection{The Complex Arctangent Function}
{[[ps/v81complexarctangent.eps]]}
...
\section{Two dimensional examples}

\subsection{A function of one variable}
{[[ps/v81equation001.eps]]}
#+NAME: equation001
#+begin_src common-lisp :noweb yes
...
\subsection{A Parametric function}
{[[ps/v81equation002.eps]]}
#+NAME: equation002
#+begin_src common-lisp :noweb yes
...
\subsection{A Polynomial in 2 variables}
{[[ps/v81equation003.eps]]}
#+NAME: equation003
#+begin_src common-lisp :noweb yes
...
\subsection{A function of two variables}
{[[ps/v81equation004.eps]]}
#+NAME: equation004
#+begin_src common-lisp :noweb yes
cf(x,y) == 0.5
...
\subsection{A parametrically defined curve}
{[[ps/v81equation005.eps]]}
#+NAME: equation005
#+begin_src common-lisp :noweb yes
...
\subsection{A parametrically defined surface}
{[[ps/v81equation006.eps]]}
#+NAME: equation006
#+begin_src common-lisp :noweb yes
f1(u,v) == u*sin(v)
f2(u,v) == v*cos(u)
...
\chapter{CRC Standard Curves and Surfaces}
...
\section{Acini Di Pepe}
{[[ps/v81acinidipepe.eps]]}
#+NAME: Acini Di Pepe
#+begin_src common-lisp :noweb yes
...
\section{Cannolicchi Rigati}
{[[ps/v81cannolicchirigati.eps]]}
...
\section{Chifferi Rigati}
{[[ps/v81chifferirigati.eps]]}
...
\section{Colonne Pompeii}
{[[ps/v81colonnepompeii.eps]]}
...
\section{Conchiglie Rigate}
{[[ps/v81conchiglierigate.eps]]}
...
\section{Conchigliette Lisce}
{[[ps/v81conchigliettelisce.eps]]}
...
\section{Conchiglioni Rigate}
{[[ps/v81conchiglionirigate.eps]]}
...
{[[ps/v81lasagnalargadoppiariccia.eps]]}
...
{[[ps/v81maccheroniallachitarra.eps]]}
...
{[[ps/v81ricciolialcinquesapori.eps]]}
