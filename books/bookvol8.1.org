...
2. [2] *determinate*
  ...
  2. [2.2] *integral* -- Certain continuous functions are not expressible
  ...
  3. [2.3] *transcendental* -- The transcendental curves cannot be
    ...
    1. [2.3.1] *exponential*
    2. [2.3.2] *logarithmic*
    3. [2.3.3] *trigonometric*
  4. [2.4] *piecewise continuous* -- Other curves, except at a few
