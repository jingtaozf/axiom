...
#+LATEX: \newcommand{\VolumeName}{Volume 8.1: Axiom Gallery}
#+LATEX: \input{bookheader.tex}
#+LATEX: \setcounter{chapter}{0} % Chapter 1
* General examples
These examples come from code that ships with Axiom in various
input files.

** Two dimensional functions

*** A Simple Sine Function
{\center{\includegraphics[scale=0.50]{ps/v81equation123.eps}}}
#+NAME: equation123
...
{\center{\includegraphics[scale=0.50]{ps/v81equation124.eps}}}
#+NAME: equation124
#+begin_src common-lisp :noweb yes
...
{\center{\includegraphics[scale=0.50]{ps/v81equation125.eps}}}
#+NAME: equation125
#+begin_src common-lisp :noweb yes
...
{\center{\includegraphics[scale=0.50]{ps/v81equation126.eps}}}
#+NAME: equation126
#+begin_src common-lisp :noweb yes
...
{\center{\includegraphics[scale=0.50]{ps/v81equation127.eps}}}
#+NAME: equation127
#+begin_src common-lisp :noweb yes
...
*** A Simple Tangent Function, Clipping On
{\center{\includegraphics[scale=0.50]{ps/v81equation128.eps}}}
#+NAME: equation128
#+begin_src common-lisp :noweb yes
...
*** Tangent and Sine
{\center{\includegraphics[scale=0.50]{ps/v81equation101.eps}}}
#+NAME: equation101
#+begin_src common-lisp :noweb yes
...
{\center{\includegraphics[scale=0.50]{ps/v81equation107.eps}}}
#+NAME: equation107
#+begin_src common-lisp :noweb yes
...
{\center{\includegraphics[scale=0.50]{ps/v81equation110.eps}}}
#+NAME: equation110
#+begin_src common-lisp :noweb yes
...
{\center{\includegraphics[scale=0.50]{ps/v81equation118.eps}}}
#+NAME: equation118
#+begin_src common-lisp :noweb yes
...
{\center{\includegraphics[scale=0.50]{ps/v81equation114.eps}}}
#+NAME: equation114
#+begin_src common-lisp :noweb yes
...
*** Lissajous Curve
{\center{\includegraphics[scale=0.50]{ps/v81equation102.eps}}}
#+NAME: equation102
#+begin_src common-lisp :noweb yes
...
*** A Parametric Curve
{\center{\includegraphics[scale=0.50]{ps/v81equation129.eps}}}
#+NAME: equation129
#+begin_src common-lisp :noweb yes
...
{\center{\includegraphics[scale=0.50]{ps/v81equation130.eps}}}
#+NAME: equation130
#+begin_src common-lisp :noweb yes
...
{\center{\includegraphics[scale=0.50]{ps/v81equation111.eps}}}
#+NAME: equation111
#+begin_src common-lisp :noweb yes
...
{\center{\includegraphics[scale=0.50]{ps/v81equation113.eps}}}
#+NAME: equation113
#+begin_src common-lisp :noweb yes
m(u:DFLOAT,v:DFLOAT):DFLOAT == 1
...
{\center{\includegraphics[scale=0.50]{ps/v81equation119.eps}}}
#+NAME: equation119
#+begin_src common-lisp :noweb yes
m(u:DFLOAT,v:DFLOAT):DFLOAT == 1
...
{\center{\includegraphics[scale=0.50]{ps/v81equation120.eps}}}
#+NAME: equation120
#+begin_src common-lisp :noweb yes
m(u:DFLOAT,v:DFLOAT):DFLOAT == 1
...
{\center{\includegraphics[scale=0.50]{ps/v81equation121.eps}}}
#+NAME: equation121
#+begin_src common-lisp :noweb yes
m(u:DFLOAT,v:DFLOAT):DFLOAT == 1
...
{\center{\includegraphics[scale=0.50]{ps/v81equation104.eps}}}
#+NAME: equation104
#+begin_src common-lisp :noweb yes
...
{\center{\includegraphics[scale=0.50]{ps/v81equation131.eps}}}
#+NAME: equation131
#+begin_src common-lisp :noweb yes
...
{\center{\includegraphics[scale=0.50]{ps/v81equation132.eps}}}
#+NAME: equation132
#+begin_src common-lisp :noweb yes
draw(curve(sin(t)*cos(3*t/5),cos(t)*cos(3*t/5),cos(t)*sin(3*t/5)),_
...
{\center{\includegraphics[scale=0.50]{ps/v81equation109.eps}}}
#+NAME: equation109
#+begin_src common-lisp :noweb yes
...
*** A Icosahedron
{\center{\includegraphics[scale=0.50]{ps/v81icosahedron.eps}}}
#+NAME: Icosahedron
#+begin_src common-lisp :noweb yes
...
{\center{\includegraphics[scale=0.50]{ps/v81kleinbagel.eps}}}
#+NAME: kleinbagel
#+begin_src common-lisp :noweb yes
r := 1
...
axes(v3d,"off")
#+end_src
From =en.wikipedia.org/wiki/Klein_bottle=. The ``figure 8'' immersion
(Klein bagel) of the Klein bottle has a particularly simple parameterization.
It is that of a ``figure 8'' torus with a 180 degree ``M\"obius'' twist
inserted. In this immersion, the self-intersection circle is a geometric
circle in the x-y plane. The positive constant $r$ is the radius of this
circle. The parameter $u$ gives the angle in the x-y plane, and $v$ specifies
the position around the 8-shaped cross section. With the above parameterization
the cross section is a 2:1 Lissajous curve.

*** A 2-Equation bipolarCylindrical Surface
{\center{\includegraphics[scale=0.50]{ps/v81equation108.eps}}}
#+NAME: equation108
#+begin_src common-lisp :noweb yes
...
{\center{\includegraphics[scale=0.50]{ps/v81equation105.eps}}}
#+NAME: equation105
#+begin_src common-lisp :noweb yes
...
{\center{\includegraphics[scale=0.50]{ps/v81equation112.eps}}}
#+NAME: equation112
#+begin_src common-lisp :noweb yes
...
{\center{\includegraphics[scale=0.50]{ps/v81equation106.eps}}}
#+NAME: equation106
#+begin_src common-lisp :noweb yes
m(u:DFLOAT,v:DFLOAT):DFLOAT == 1
...
{\center{\includegraphics[scale=0.50]{ps/v81equation115.eps}}}
#+NAME: equation115
#+begin_src common-lisp :noweb yes
...
{\center{\includegraphics[scale=0.50]{ps/v81equation116.eps}}}
#+NAME: equation116
#+begin_src common-lisp :noweb yes
...
{\center{\includegraphics[scale=0.50]{ps/v81equation122.eps}}}
#+NAME: equation122
#+begin_src common-lisp :noweb yes
...
{\center{\includegraphics[scale=0.50]{ps/v81equation117.eps}}}
#+NAME: equation117
#+begin_src common-lisp :noweb yes
...
{\center{\includegraphics[scale=0.50]{ps/v81complexgamma.eps}}}
#+NAME: complexgamma
#+begin_src common-lisp :noweb yes
...
#+end_src
A 3-d surface whose height is the real part of the Gamma function,
and whose color is the argument of the Gamma function.

*** The Complex Arctangent Function
{\center{\includegraphics[scale=0.50]{ps/v81complexarctangent.eps}}}
#+NAME: complexarctangent
#+begin_src common-lisp :noweb yes
...
rotate(v3d,210,-60)
#+end_src
The complex arctangent function. The height is the real part and
the color is the argument.


* Hyperdoc examples
Examples in this section come from the Hyperdoc documentation tool.
These examples are accessed from the Basic Examples Draw section.

** Two dimensional examples

*** A function of one variable
{\center{\includegraphics[scale=0.50]{ps/v81equation001.eps}}}
#+NAME: equation001
#+begin_src common-lisp :noweb yes
draw(x*cos(x),x=0..30,title=="y = x*cos(x)")
#+end_src
This is one of the demonstration equations used in hypertex.
It demonstrates a function of one variable. It draws
\[y = f(x) \]
where $y$ is the dependent variable and $x$ is the independent variable.

*** A Parametric function
{\center{\includegraphics[scale=0.50]{ps/v81equation002.eps}}}
#+NAME: equation002
#+begin_src common-lisp :noweb yes
draw(curve(-9*sin(4*t/5),8*sin(t)),t=-5*%pi..5*%pi,title=="Lissajous")
#+end_src
This is one of the demonstration equations used in hypertex.
It draw a parametrically defined curve
\[f1(t), f2(t)\]
in terms of two functions $f1$ and $f2$ and an independent variable t.

*** A Polynomial in 2 variables
{\center{\includegraphics[scale=0.50]{ps/v81equation003.eps}}}
#+NAME: equation003
#+begin_src common-lisp :noweb yes
draw(y**2+7*x*y-(x**3+16*x) = 0,x,y,range==[-15..10,-10..50])
#+end_src
This is one of the demonstration equations used in hypertex.
Plotting the solution to 
\[p(x,y) = 0\]
...
{\center{\includegraphics[scale=0.50]{ps/v81equation004.eps}}}
#+NAME: equation004
#+begin_src common-lisp :noweb yes
cf(x,y) == 0.5
...
A function of two variables 
\[z = f(x,y)\]
where $z$ is the dependent variable and where $x$ and $y$ are the
dependent variables.

*** A parametrically defined curve
{\center{\includegraphics[scale=0.50]{ps/v81equation005.eps}}}
#+NAME: equation005
#+begin_src common-lisp :noweb yes
...
#+end_src
This is one of the demonstration equations used in hypertex.
This ia parametrically defined curve
\[ f1(t), f2(t), f3(t) \]
in terms of three functions $f1$, $f2$, and $f3$ and an independent
variable $t$.

*** A parametrically defined surface
{\center{\includegraphics[scale=0.50]{ps/v81equation006.eps}}}
#+NAME: equation006
#+begin_src common-lisp :noweb yes
f1(u,v) == u*sin(v)
f2(u,v) == v*cos(u)
...
graphics code we turn to the CRC Standard Curves and Surfaces [cite:@Segg93] 
(SCC).
...
\item[1.1] *fractal*
\item[1.2] *gaussian*
\item[1.3] *non-gaussian*
\end{enumerate}
\item[2] *determinate*
\begin{enumerate}
\item[2.1] *algebraic* -- A polynomial is defined as a summation of terms
...
functions of $x$. 
\begin{enumerate}
\item[2.1.1] *irrational* -- An irrational function of $x$ is a quotient
of two polynomials, one or both of which has a term (or terms) with power
$p/q$, where $p$ and $q$ are integers.
\item[2.1.2] *rational* -- A rational function of $x$ is a quotient of two
polynomials in $x$, both having only integer powers.
\begin{enumerate}
\item[2.1.2.1] *polynomial*
\item[2.1.2.2] *non-polynomial*
\end{enumerate}
\end{enumerate}
\item[2.2] *integral* -- Certain continuous functions are not expressible 
...
\item[2.3] *transcendental* -- The transcendental curves cannot be 
...
\begin{enumerate}
\item[2.3.1] *exponential*
\item[2.3.2] *logarithmic*
\item[2.3.3] *trigonometric*
\end{enumerate}
\item[2.4] *piecewise continuous* -- Other curves, except at a few 
...
\begin{enumerate}
\item[2.4.1] *periodic*
\item[2.4.2] *non-periodic*
\item[2.4.3] *polygonal*
\begin{enumerate}
\item[2.4.3.1] *regular*
\item[2.4.3.2] *irregular*
\item[2.4.3.3] *fractal*
\end{enumerate}
\end{enumerate}
\end{enumerate}
\end{enumerate}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp26-2.1.1.1-3.eps}}}
...
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp26-2.1.1.4-6.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp26-2.1.2.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp26-2.1.2.4-6.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp28-2.1.3.1-6.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp28-2.1.3.7-10.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp28-2.1.4.1-6.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp28-2.1.4.7-10.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp30-2.2.1.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp30-2.2.2.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp30-2.2.3.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp30-2.2.4.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp30-2.2.5.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp30-2.2.6.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp32-2.2.7.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp32-2.2.8.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp32-2.2.9.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp32-2.2.10.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp32-2.2.11.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp32-2.2.12.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp34-2.2.13.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp34-2.2.14.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp34-2.2.15.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp34-2.2.16.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp34-2.2.17.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp34-2.2.18.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp36-2.2.19.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp36-2.2.20.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp36-2.2.21.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp36-2.2.22.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp36-2.2.23.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp36-2.2.24.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp38-2.2.25.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp38-2.2.26.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp38-2.2.27.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp38-2.2.28.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp38-2.2.29.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp38-2.2.30.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp40-2.2.31.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp40-2.2.32.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp40-2.2.33.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp42-2.3.1.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp42-2.3.2.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp42-2.3.3.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp42-2.3.4.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp44-2.3.5.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp44-2.3.6.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp44-2.3.7.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp44-2.3.8.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp46-2.4.1.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp46-2.4.2.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp46-2.4.3.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp46-2.4.4.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp48-2.4.5.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp48-2.4.6.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp48-2.4.7.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp48-2.4.8.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp50-2.5.1.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp50-2.5.2.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp50-2.5.3.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp50-2.5.4.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp50-2.5.5.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp50-2.5.6.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp52-2.6.1.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp52-2.6.2.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp52-2.6.3.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp52-2.6.4.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp52-2.6.5.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp52-2.6.6.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp54-2.7.1.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp54-2.7.2.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp54-2.7.3.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp54-2.7.4.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp54-2.7.5.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp54-2.7.6.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp56-2.8.1.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp56-2.8.2.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp56-2.8.3.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp56-2.8.4.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp56-2.8.5.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp56-2.8.6.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp58-2.9.1.1-3.eps}}}
...
#+end_src
%{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp58-2.9.2.1-3.eps}}}
...
#+end_src
%{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp58-2.9.3.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp58-2.9.4.1-3.eps}}}
...
makeViewport2D(viewport1)
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp58-2.9.5.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp58-2.9.6.1-3.eps}}}
...
#+end_src
%{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp60-2.9.7.1-3.eps}}}
...
#+end_src
%{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp60-2.9.8.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp60-2.9.9.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp60-2.9.10.1-3.eps}}}
...
#+end_src
{\center{\includegraphics[height=8cm,width=8cm]{ps/v81crcp60-2.9.11.1-6.eps}}}
# label: CRCp60-2.9.11.1-6
#+INDEX: figures!CRCp60-2.9.11.1-6

* Pasta by Design
This is a book[cite:@Lege11] that combines a taxonomy of pasta shapes with the
Mathematica equations that realize those shapes in three dimensions.
We implemented examples from this book as a graphics test suite for Axiom.

** Acini Di Pepe
{\center{\includegraphics[scale=0.50]{ps/v81acinidipepe.eps}}}
#+NAME: Acini Di Pepe
#+begin_src common-lisp :noweb yes
...
axes(v3d,"off")
#+end_src
The smallest member of the /postine minute/ (tiny pasta) family,
/acini de pepe/ (peppercorns) are most suited to consommes (clear
soups), with the occasional addition of croutons and diced greens. 
Made of durum wheat flour and eggs, acini di pepe are commonly used 
in the Italian-American ``wedding soup'', a broth of vegetables and meat.

** Agnolotti
{\center{\includegraphics[scale=0.50]{ps/v81agnolotti.eps}}}
#+NAME: Agnolotti
#+begin_src common-lisp :noweb yes
...
#+end_src
These shell-like /ravioli/ from Piedmont, northern italy, are fashioned
from small pieces of flattened dough made of wheat flour and egg, and
are often filled with braised veal, port, vegetables or cheese. The
true agnolotto should feature a crinkled edge, cut using a fluted
pasta wheel. Recommended with melted butter and sage

** Anellini
{\center{\includegraphics[scale=0.50]{ps/v81anellini.eps}}}
#+NAME: Anellini
#+begin_src common-lisp :noweb yes
X(i,j) == cos(0.01*i*%pi)
...
zoom(vp,1.1,1.1,1.1)
#+end_src
The diminutive /onellini/ (small rings) are part of the extended
/postine minute/ (tiny pasta) clan. Their thickness varies between
only 1.15 and 1.20 mm, and the are therefore usually found in light
soups together with croutons and thinly sliced vegetables. This pasta
may also be found served in a /timballo/ (baked pasta dish).

** Bucatini
{\center{\includegraphics[scale=0.50]{ps/v81bucatini.eps}}}
#+NAME: Bucatini
#+begin_src common-lisp :noweb yes
...
zoom(vp,2.0,2.0,2.0)
#+end_src
/Bucatini/ (pierced) pasta is commonly served as a {\sl
pastasciutta} (pasta boiled, drained, and dished up with a sauce,
rather than in broth). Its best known accompaniment is {\sl
amatriciana}: a hearty traditional sauce made with dried port,
Pecorino Romano and tomato sauce, and named after the medieval town of
Amatrice in central Italy.

** Buccoli
{\center{\includegraphics[scale=0.50]{ps/v81buccoli.eps}}}
#+NAME: Buccoli
#+begin_src common-lisp :noweb yes
...
#+end_src
A spiral-shaped example from the /pasta corta/ (short pasta)
family, and of rather uncertain pedigree, /buccoli/ are suitable
in a mushroom and sausage dish. They are also excellent with a tomato
aubergine, pesto, and ricotta salad.

** Calamaretti
{\center{\includegraphics[scale=0.50]{ps/v81calamaretti.eps}}}
#+NAME: Calamaretti
#+begin_src common-lisp :noweb yes
...
#+end_src
Literally ``little squids'', /calamaretti/ are small ring-shaped
pasta cooked as /pastasciutta/ (pasta boiled and drained) then
dished up with a tomato-, egg-, or cheese-based sauce. Their shape
means that /calamaretti/ hold both chunky and thin sauces equally
well. Fittingly, they are often served with seafood.

** Cannelloni
{\center{\includegraphics[scale=0.50]{ps/v81cannelloni.eps}}}
#+NAME: Cannelloni
#+begin_src common-lisp :noweb yes
...
zoom(v3d,2.0,2.0,2.0)
#+end_src
Made with wheat flour, eggs, and olive oil, /cannelloni/ (big
tubes) originate as strips of pasta shaped into perfect cylinders,
which can be stuffed with meat, vegetables, or ricotta. The stuffed
/cannelloni/ are covered with a creamy {besciamella} sauce, a
sprinkling of Parmigiano-Reggiano cheese and then oven-baked.

** Cannolicchi Rigati
{\center{\includegraphics[scale=0.50]{ps/v81cannolicchirigati.eps}}}
...
#+end_src
Known as ``little tubes'', /cannolicchi/ exist both in a {\sl
rigati} (grooved) and /lisci/ (smooth) form. These hollow {\sl
pasta corta} (short pasta) come in various diameters and are often
served with seafood. /Cannolicchi/ hail from Campania in southern Italy.

** Capellini
{\center{\includegraphics[scale=0.50]{ps/v81capellini.eps}}}
#+NAME: Capellini
#+begin_src common-lisp :noweb yes
...
zoom(v3d,3.0,3.0,3.0)
#+end_src
An extra-fine rod-like pasta /capellini/ (thin hair) may be served
in a light broth, but also combine perfectly with butter, nutmeg, or
lemon. This variety (or its even more slender relative, {\sl capelli
d'angelo} (angel hair) is sometimes used to form the basis of an
unusual sweet pasta dish, made with lemons and almonds, called {\sl
torta ricciolina}.

** Cappelletti
{\center{\includegraphics[scale=0.50]{ps/v81cappelletti.eps}}}
#+NAME: Cappelletti
#+begin_src common-lisp :noweb yes
...
north Italian Christmas meal, dished up in a chicken brodo
(broth). Typically, it is the children of a houseold who prepare the
cappelletti (little hats) on Christmas Eve, filling the pasta parcels
(made from wheat flour and fresh eggs) with mixed meats or soft
cheeses, such as ricotta.

** Casarecce
{\center{\includegraphics[scale=0.50]{ps/v81casarecce.eps}}}
#+NAME: Casarecce
#+begin_src common-lisp :noweb yes
X(i,j) == _ 
  if (i <= 30)_
...
zoom(v3d,3.0,3.0,3.0)
#+end_src
Easily identified by their unique s-shaped cross-section {\sl
casarecce} (home-made) are best cooked as /postasciutta/ (pasta
boiled, drained and dished up with a sauce). Often /casarecce/ are
served with a classic /ragu/ and topped with a sprinkle of pepper
and Parmigiano-Reggiano cheese.

** Castellane
{\center{\includegraphics[scale=0.50]{ps/v81castellane.eps}}}
#+NAME: Castellane
#+begin_src common-lisp :noweb yes
...
#+end_src
The manufacturer Bailla has recently created this elegant pasta
shape. Accordking to its maker, they were originally called {\sl
paguri} (hermit crabs) but renamed /castellane/ (castle
dwellers). The sturdy form and rich nutty taste of /castellane/
stand up to hearty meals and full-flavoured sauces.

** Cavatappi
{\center{\includegraphics[scale=0.50]{ps/v81cavatappi.eps}}}
#+NAME: Cavatappi
#+begin_src common-lisp :noweb yes
...
zoom(v3d,3.0,3.0,3.0)
#+end_src
Perfect with chunky sauces made from lamb or pork, /cavatappi/
(corkscrews) are 36 mm-long, hollow helicoidal tubes. As well as an
accompaniment to creamy sauces, such as /boscaiola/ (woodsman's)
sauce, they are also often used in oven-baked cheese-topped dishes, or
in salads with pesto.

** Cavatelli
{\center{\includegraphics[scale=0.50]{ps/v81cavatelli.eps}}}
#+NAME: Cavatelli
#+begin_src common-lisp :noweb yes
...
zoom(v3d,1.5,1.5,1.5)
#+end_src
Popular in the south of Italy, and related in shape to the longer
twisted /casareccia/, /cavatelli/ can be served {\sl alla
puttanesca} (with a sauce containing chilli, garlic, capers, and
anchovies). They can also be added to a salad with olive oil, sauteed
crushed garlic and a dusting of soft cheese.

** Chifferi Rigati
{\center{\includegraphics[scale=0.50]{ps/v81chifferirigati.eps}}}
...
rotate(v3d,90,180)
#+end_src
This pasta - available in both /rigoti/ (grooved) and /lisci/
(smooth) forms - is typically cooked in broth or served in {\sl rogu
alla bolognese}, though /chifferi rigati/ also make an excellent
addition to salads with carrot, red pepper and courgette. {\sl
Chifferi rigoti} bear a resemblance to, and the term is a
transliteration of, the Austrian 'kipfel' sweet.

** Colonne Pompeii
{\center{\includegraphics[scale=0.50]{ps/v81colonnepompeii.eps}}}
...
zoom(vp,3.0,3.0,3.0)
#+end_src
This ornate pasta (originally from Campania, southern Italy) is
similar in shape to /fusilloni/ (a large /fusilli/) but is
substantially longer. /Colonne Pompeii/ (columns of Pompeii) are
best served with a seasoning of fresh basil, pine nuts, finely sliced
garlic and olive oil, topped with a sprinkling of freshly grated
Parmigiano-Reggiano.

** Conchiglie Rigate
{\center{\includegraphics[scale=0.50]{ps/v81conchiglierigate.eps}}}
...
zoom(v3d,1.5,1.5,1.5)
#+end_src
Shaped like their namesake, /conchiglie/ (shells) exist in both
/rigate/ (grooved) and /lisce/ (smooth) forms. Suited to light
tomato sauces, ricotta cheese or /pesto genovese/, {\sl
conchiglie} hold flavourings in their grooves and cunningly designed
shell. Smaller versions are used in soups, while larger shells are
more commonly served with a sauce.

** Conchigliette Lisce
{\center{\includegraphics[scale=0.50]{ps/v81conchigliettelisce.eps}}}
...
zoom(v3d,1.5,1.5,1.5)
#+end_src
Typically found in central and southern Italy (notably Campania), {\sl
conchigliette lisce} (small smooth shells) can be served in soups such
as /minestrone/. Alternatively, these shells can accompany a meat-
or vegetable-based sauce.

** Conchiglioni Rigate
{\center{\includegraphics[scale=0.50]{ps/v81conchiglionirigate.eps}}}
#+NAME: Conchiglioni Rigate
#+begin_src common-lisp :noweb yes
...
zoom(v3d,1.5,1.5,1.5)
#+end_src
The shape of /conchiglioni rigate/ (large ribbed shells) is ideal
for holding sauces and fillings (either fish or meat based) and the
pasta can be baked in the oven, or placed under a grill and cooked as
a gratin. /Conchiglioni rigati/ are often served in the
Italian-American dish /pasta primavera/ (pasta in spring sauce)
alongside crisp spring vegetables.

** Corallini Lisci
{\center{\includegraphics[scale=0.50]{ps/v81corallinilisci.eps}}}
...
zoom(vp,2.0,2.0,2.0)
#+end_src
Members of the /postine minute/ (tiny pasta) group, {\sl corallini
...
** Creste Di Galli
{\center{\includegraphics[scale=0.50]{ps/v81crestedigalli.eps}}}
...
zoom(v3d,1.5,1.5,1.5)
#+end_src
Part of the /pasta ripiena/ (filled pasta) family, {\sl creste di
galli} (coxcombs) are identical to /galletti/ except for the
crest, which is smooth rather than crimped. They may be stuffed,
cooked and served in a simple /marinara/ (mariner's) sauce, which
contains tomato, garlic, and basil.

** Couretti
{\center{\includegraphics[scale=0.50]{ps/v81couretti.eps}}}
#+NAME: Couretti
#+begin_src common-lisp :noweb yes
...
axes(v3d,"off")
#+end_src
A romantically shaped scion of the /postine minute/ (tiny pasta)
clan, /cuoretti/ (tiny hearts) are minuscule. In fact, along with
/acini di pepe/, they are one of the smallest forms of pasta. Like
all /postine/ they may be served in soup, such as cream of chicken.

** Ditali Rigati
{\center{\includegraphics[scale=0.50]{ps/v81ditalirigati.eps}}}
#+NAME: Ditali Rigati
#+begin_src common-lisp :noweb yes
...
10 mm long. Like other /pastine/, they are usually found in soups
such as /pasta e patate/. Their stocky shape makes them a
sustaining winter snack, as well as an excellent addition to salads.

** Fagottini
{\center{\includegraphics[scale=0.50]{ps/v81fagottini.eps}}}
#+NAME: Fagottini
#+begin_src common-lisp :noweb yes
...
** Farfalle
{\center{\includegraphics[scale=0.50]{ps/v81farfalle.eps}}}
#+NAME: Farfalle
#+begin_src common-lisp :noweb yes
...
#+end_src
A mixture of durum-wheat flour, eggs, and water, /farfalle/
(butterflies) come from the Emilia-Romagnaand Lombardy regions of
northern Italy. They are best served in a rich /carbonara/ sauce
(made with cream, eggs, and bacon). Depending on se, /farfalle/
might be accompanied by green peas and chicken or ham.

** Farfalline
{\center{\includegraphics[scale=0.50]{ps/v81farfalline.eps}}}
#+NAME: Farfalline
#+begin_src common-lisp :noweb yes
...
zoom(v3d,1.5,1.5,1.5)
#+end_src
The small size of this well-known member of the /postine minute/
(tiny pasta) lineage means that /farfalline/ (tiny butterflies),
are suitable for light soups, such as /pomodori e robiolo/ (a
mixture of tomato and soft cheese). A crimped pasta cutter and a
central pinch create the iconic shape.

** Farfalloni
{\center{\includegraphics[scale=0.50]{ps/v81farfalloni.eps}}}
#+NAME: Farfalloni
#+begin_src common-lisp :noweb yes
...
#+end_src
Like /farfalle/, /farfalloni/ (large butterflies) are well
...
** Festonati
{\center{\includegraphics[scale=0.50]{ps/v81festonati.eps}}}
#+NAME: Festonati
#+begin_src common-lisp :noweb yes
...
axes(v3d,"off")
#+end_src
This famous /pasta lunga/ (long pasta) is made with durum-wheat
flour, water, and in the case of /fettuccine alluovo/, eggs
ideally within days of laying. /Fettuccine/ (little ribbons) hail
from the Lazio region. Popular in many dishes, they are an ideal
accompaniment to /Alfredo/ sauce, a rich mix of cream, parmesan,
garlic, and parsley.

** Fiocchi Rigati
{\center{\includegraphics[scale=0.50]{ps/v81fiocchirigati.eps}}}
#+NAME: Fiocchi Rigati
#+begin_src common-lisp :noweb yes
...
zoom(v3d,2.0,2.0,2.0)
#+end_src
A distant relative of the /farfalle/ family, /fiocchi rigati/
(grooved flakes) are smaller than either /farfalloni/ or {\sl
farfalle}, but larger than /farfalline/. Their corrugated surface
collects more sauce than a typical /farfalle/. For a more unusual
disk, /fiocchi rigati/ can be served in a tomato and vodka sauce.

** Fisarmoniche
{\center{\includegraphics[scale=0.50]{ps/v81fisarmoniche.eps}}}
#+NAME: Fisarmoniche
#+begin_src common-lisp :noweb yes
...
recall - /fisarmoniche/ are perfect for capturing thick sauces,
...
** Funghini
{\center{\includegraphics[scale=0.50]{ps/v81funghini.eps}}}
#+NAME: Funghini
#+begin_src common-lisp :noweb yes
...
axes(v3d,"off")
#+end_src
The modest dimensions of this /pastine minute/ (tiny pasta) make
/funghini/ (little mushrooms) especially suitable for soups, such
as a /minestrone/ made from chopped and sauteed celeriac.

** Fusilli
{\center{\includegraphics[scale=0.50]{ps/v81fusilli.eps}}}
#+NAME: Fusilli
#+begin_src common-lisp :noweb yes
...
zoom(v3d,2.0,2.0,2.0)
#+end_src
A popular set from the /pasta corta/ (short pasta) family, {\sl
fusilli} (little spindles) were originally made by quickly wrapping a
/spaghetto/ around a large needle. Best served as {\sl
pastasciutta} (pasta boild and drained) with a creamy sauce containing
slices of spicy sausage.

\section{Fusilli al Ferretto} 
{\center{\includegraphics[scale=0.50]{ps/v81fusillialferretto.eps}}}
...
zoom(v3d,3.0,3.0,3.0)
#+end_src
To create this Neapolitan variety of
/fusilli/, a small amount of durum-wheat flour is kneaded and
placed along a /ferretto/ (small iron stick) that is then rolled
...
spasa}. /Fusilli al ferretto/ are best dished up with a lamb /ragu/.

** Fusilli Capri
{\center{\includegraphics[scale=0.50]{ps/v81fusillicapri.eps}}}
#+NAME: Fusilli Capri
#+begin_src common-lisp :noweb yes
...
zoom(v3d,2.5,2.5,2.5)
#+end_src
A longer and more compact regional adaptation of /fusilli/, {\sl
fusilli Capri} are suited to a hearty /ragu/ of lamb or por sausages,
or may also be combined with rocket and lemon to form a lighter dish.

** Fusilli Lunghi Bucati
{\center{\includegraphics[scale=0.50]{ps/v81fusillilunghibucati.eps}}}
...
zoom(v3d,2.5,2.5,2.5)
#+end_src
A distinctive member of the extended /fusilli/ clan, {\sl fusilli
lunghi bucati} (long pierced /fusilli/) originated in Campania,
southern Italy, and have a spring-like profile. Like all /fusilli/
they are traditionally consumed with a meat-based /ragu/, but may
also be combined with thick vegetable sauces and baked in an oven.

** Galletti
{\center{\includegraphics[scale=0.50]{ps/v81galletti.eps}}}
#+NAME: Galletti
#+begin_src common-lisp :noweb yes
...
chifferi} with the addtion of an undulating crest. /Galletti/ are
usually served in tomato sauces, but combine wqually well with a {\sl
boscaiola} (woodsman's) sauce of mushrooms.

** Garganelli
{\center{\includegraphics[scale=0.50]{ps/v81garganelli.eps}}}
#+NAME: Garganelli
#+begin_src common-lisp :noweb yes
...
viewpoint(v3d,-5,0,0)
#+end_src
A grooved /pasta corta/ (short pasta), similar to /maccheroni/
but with pointed slanting ends, /garganelli/ are shaped like the
gullet of a chicken ('/garganel/' in the northern Italian
...
** Gemelli
{\center{\includegraphics[scale=0.50]{ps/v81gemelli.eps}}}
#+NAME: Gemelli
#+begin_src common-lisp :noweb yes
...
zoom(v3d,2.5,2.5,2.5)
#+end_src
To create a /gemello/, a single pasta strand is twisted into a
...
** Gigli
{\center{\includegraphics[scale=0.50]{ps/v81gigli.eps}}}
#+NAME: Gigli
#+begin_src common-lisp :noweb yes
...
zoom(v3d,2.0,2.0,2.0)
#+end_src
With their fluted edges and cone-like shape, /gigli/ resemble
small bells (/campanelle/) or lilies (/gigli/), after which
they are named. Another more recent design, /gigli/ are shaped to
capture thick meaty sauces.

** Giglio Ondulato
{\center{\includegraphics[scale=0.50]{ps/v81giglioondulato.eps}}}
...
zoom(v3d,2.0,2.0,2.0)
#+end_src
Identical to /gigli/ but with crenellated edges, {\sl giglio
ondulato} are made of durum-wheat flour and water.

** Gnocchetti Sardi
{\center{\includegraphics[scale=0.50]{ps/v81gnocchettisardi.eps}}}
...
zoom(v3d,1.5,1.5,1.5)
#+end_src
As their name suggests, /gnocchetti/ are simply small {\sl
gnocchi} (or 'dumplings'). They go well with ricotta or Pecorino
Romano cheese, or served with thick sauces such as a veal {\sl
ragu}. /Gnocchetti/ originated in Sardinia, a Mediterranean island
to the west of Italy.

** Gnocchi
{\center{\includegraphics[scale=0.50]{ps/v81gnocchi.eps}}}
#+NAME: Gnocchi
#+begin_src common-lisp :noweb yes
...
zoom(v3d,1.5,1.5,1.5)
#+end_src
Members of an extended family, /gnocchi/ (dumplings) often
...
to type. /Gnocchi/ are often added to a sauce made from fontina cheese.

** Gramigna
{\center{\includegraphics[scale=0.50]{ps/v81gramigna.eps}}}
#+NAME: Gramigna
#+begin_src common-lisp :noweb yes
...
bolognese}. Alternatively, /gramigna/ are sometimes presented {\sl
alla pomodoro} (with a light tomato sauce).

** Lancette
{\center{\includegraphics[scale=0.50]{ps/v81lancette.eps}}}
#+NAME: Lancette
#+begin_src common-lisp :noweb yes
...
zoom(v3d,3.0,3.0,3.0)
#+end_src
No longer than 15mm, /lancette/ or 'hands' (of a clock) belong to
the /postine minute/ (tiny pasta) clan. They are delicious in
...
{\center{\includegraphics[scale=0.50]{ps/v81lasagnalargadoppiariccia.eps}}}
...
zoom(v3d,3.0,3.0,3.0)
#+end_src
As their name suggests, /lasagna larga doppia riccia/ (large
...
sauce. /Lasagne/ are excellent with ricotta and a {\sl ragu
napoletano}, or cooked /al forno/ (at the oven) with a creamy {\sl
besciamella} sauce.

** Linguine
{\center{\includegraphics[scale=0.50]{ps/v81linguine.eps}}}
#+NAME: Linguine
#+begin_src common-lisp :noweb yes
X(i,j) == cos(i*%pi/75)
Y(i,j) == 2*sin(i*%pi/75)
...
zoom(v3d,2.5,2.5,2.5)
#+end_src
The thinnest member of the /bavette/ (little dribble) family, {\sl
...
** Lumaconi Rigati
{\center{\includegraphics[scale=0.50]{ps/v81lumaconirigati.eps}}}
...
rotate(v3d,90,180)
#+end_src
Originally from Campania and Liguria, /lumaconi rigati/ (big
...
in /besciamella/ and cooked in the oven. Smaller members of the
family (/lumache/) are also available.

** Maccheroni
{\center{\includegraphics[scale=0.50]{ps/v81maccheroni.eps}}}
#+NAME: Maccheroni
#+begin_src common-lisp :noweb yes
...
zoom(v3d,2.0,2.0,2.0)
#+end_src
The origin of the name /maccheroni/ is uncertain. It is used
generically to describe a hollow /pasta corta/ (short pasta) that
is moade of durum-wheat flour and perhasp eggs. The pasta can be
served /con le sarde/ (with sardines) - a dish enhanced by a touch
of fennel.

** Maccheroni Alla Chitarra
{\center{\includegraphics[scale=0.50]{ps/v81maccheroniallachitarra.eps}}}
...
alla chitarra} (guitar /maccheroni/) have a square cross-section,
produced when a thin sheet of pasta is pressed through a frame of
closely ranged wires (or /chitarra/) that lends the pasta its
name. Usually seved with a mutton /ragu/, or /pallottelle/
(veal meatballs).

** Mafaldine
{\center{\includegraphics[scale=0.50]{ps/v81mafaldine.eps}}}
#+NAME: Mafaldine
#+begin_src common-lisp :noweb yes
X(i,j) == 7.0*i/18.0
Y(i,j) == j/3.0
...
the House of Savoy, /mafaldine/ are thin flat sheets of
durum-wheat flour pasta with a rippled finish on each long edge. They
are generally served with meaty sauces such as /ragu napoletano/
or in seafood dishes.

** Manicotti
{\center{\includegraphics[scale=0.50]{ps/v81manicotti.eps}}}
#+NAME: Manicotti
#+begin_src common-lisp :noweb yes
...
zoom(v3d,1.5,1.5,1.5)
#+end_src
One of the oldest-known durum-wheat varieties, /manicotti/
...
** Orecchiette
{\center{\includegraphics[scale=0.50]{ps/v81orecchiette.eps}}}
#+NAME: Orecchiette
#+begin_src common-lisp :noweb yes
...
** Paccheri
{\center{\includegraphics[scale=0.50]{ps/v81paccheri.eps}}}
#+NAME: Paccheri
#+begin_src common-lisp :noweb yes
...
zoom(v3d,2.0,2.0,2.0)
#+end_src
Part of the /pasta corta/ (short pasta) family, /paccheri/ are
...
name stems from the term /paccare/, which means 'to smack' in the
southern Italian region of Campania.

** Pappardelle
{\center{\includegraphics[scale=0.50]{ps/v81pappardelle.eps}}}
#+NAME: Pappardelle
#+begin_src common-lisp :noweb yes
...
axes(vp,"off")
#+end_src
This /pasta lunga/ (long pasta) is often cooked with duck, pigeon,
or other game fowl. /Pappardelle/ are so popular that towns in
Italy hold festivals in their honour, such as the {\sl Sagra delle
Pappardelle al Cinghiale} (Feast of the /Pappardelle/ and Boar) in
Torre Alfina, central Italy.

** Penne Rigate
{\center{\includegraphics[scale=0.50]{ps/v81pennerigate.eps}}}
#+NAME: Penne Rigate
#+begin_src common-lisp :noweb yes
X(i,j) == _
  if (i < 85) _
...
zoom(v3d,2.0,2.0,2.0)
#+end_src
A versatile pasta, /penne rigate/ (grooved quills) come from
Campania, in southern Italy, and belong to the /pasta corta/
(short pasta) family. they can be served with spicy /arrabbiata/
(angry) sauce, which gets its name from the chillies and red peppers
it contains.

** Pennoni Lisci
{\center{\includegraphics[scale=0.50]{ps/v81pennonilisci.eps}}}
#+NAME: Pennoni Lisci
#+begin_src common-lisp :noweb yes
X(i,j) == _ 
  if (i < 100) _
...
zoom(v3d,2.0,2.0,2.0)
#+end_src
Similar in appearance to /penne rigate/, but larger and without
the grooves, /pennoni/ (large quills) require a more oily sauce
(perhaps containing sliced chorizo) to cling to their smooth surface.

** Pennoni Rigati
{\center{\includegraphics[scale=0.50]{ps/v81pennonirigati.eps}}}
#+NAME: Pennoni Rigati
#+begin_src common-lisp :noweb yes
...
zoom(v3d,2.0,2.0,2.0)
#+end_src
The angled trim of the /penne/ pasta family makes its members easy
to recognize. /Pennoni rigati/ (large grooved quills) are the
ridged version of /pennoni/, and can be stuffed and cooked.

** Puntalette
{\center{\includegraphics[scale=0.50]{ps/v81puntalette.eps}}}
#+NAME: Puntalette
#+begin_src common-lisp :noweb yes
...
zoom(v3d,1.5,1.5,1.5)
#+end_src
Another member of the /pastine minute/ (tiny pasta) family, {\sl
puntalette} (tiny tips) are about 9 mm long, and no thicker than 3
mm. Like most /pastine/, they are best consumed in creamy soups,
or perhaps in a salad.

** Quadrefiore
{\center{\includegraphics[scale=0.50]{ps/v81quadrefiore.eps}}}
#+NAME: Quadrefiore
#+begin_src common-lisp :noweb yes
...
zoom(v3d,2.5,2.5,2.5)
#+end_src
An uncommon variety of /pasta corta/ (short pasta), {\sl
...
** Quadretti
{\center{\includegraphics[scale=0.50]{ps/v81quadretti.eps}}}
#+NAME: Quadretti
#+begin_src common-lisp :noweb yes
X(i,j) == 3.0*i/14.0
Y(i,j) == 3.0*j/14.0
...
nutmeg. /Quadretti/ (tiny squares) are a classic /pastine/
...
** Racchette
{\center{\includegraphics[scale=0.50]{ps/v81racchette.eps}}}
#+NAME: Racchette
#+begin_src common-lisp :noweb yes
...
axes(vp,"off")
#+end_src
Usually served in salads, /racchette/ (rackets) suit crunchy pine
...
** Radiatori
{\center{\includegraphics[scale=0.50]{ps/v81radiatori.eps}}}
#+NAME: Radiatori
#+begin_src common-lisp :noweb yes
X(i,j) == (1.5+3*(i/70.0)^5+4*sin(j*%pi/200)^50)*cos(4*i*%pi/175)
Y(i,j) == (1.5+3*(i/70.0)^5+4*sin(j*%pi/200)^50)*sin(4*i*%pi/175)
...
zoom(v3d,2.0,2.0,2.0)
#+end_src
Small and squat, /radiatori/ (radiators) are named after their
ruffled edge When boiled, drained, and served as a /pastasciutta/
...
is often accompanied by a lamb-, veal-, rabbit-, or pork-based /ragu/.

** Ravioli Quadrati
{\center{\includegraphics[scale=0.50]{ps/v81ravioliquadrati.eps}}}
...
zoom(v3d,2.0,2.0,2.0)
#+end_src
Except for the square outline, /ravioli quadrati/ (square ravioli)
are made in an identical fashion to /ravioli tondi/ (round {\sl
ravioli}). Other variations on the theme include crescents, triangles,
and hearts. Some suggest the name /ravioli/ derives from the verb
meaning 'to wrap', others link it with /rapa/, the Italian word
for turnip.

** Ravioli Tondi
{\center{\includegraphics[scale=0.50]{ps/v81raviolitondi.eps}}}
#+NAME: Ravioli Tondi
#+begin_src common-lisp :noweb yes
...
zoom(v3d,2.0,2.0,2.0)
#+end_src
By far the best-known /pasta ripiena/ (filled pasta), {\sl ravioli
tondi} (round /ravioli/) are made by sealing a filling between two
...
** Riccioli
{\center{\includegraphics[scale=0.50]{ps/v81riccioli.eps}}}
#+NAME: Riccioli
#+begin_src common-lisp :noweb yes
...
zoom(v3d,2.0,2.0,2.0)
#+end_src
A well-know /pasta corta/ (short pasta), /riccioli/ (curls)
originated in the Emilia-Romagna region of northern Italy. Their
ribbed exterior and hollow shape mean /riccioli/ can retain a
large quantity of sauce.

** Riccioli al Cinque Sapori
{\center{\includegraphics[scale=0.50]{ps/v81ricciolialcinquesapori.eps}}}
#+NAME: Riccioli al Cinque Sapori
#+begin_src common-lisp :noweb yes
...
zoom(v3d,2.5,2.5,2.5)
#+end_src
/Riccioli/ and /riccioli al cinque sapori/ (curls in five
flavors) are both members of the /pasta corta/ (small pasta)
family, without being related by structural similarities. Made of
durum-wheat flour, /riccioli al cinque sapori/ get their color
from the addition of spinach, tomato, beetroot, and turmeric, and are
usually served in broth.

** Rigatoni
{\center{\includegraphics[scale=0.50]{ps/v81rigatoni.eps}}}
#+NAME: Rigatoni
#+begin_src common-lisp :noweb yes
...
zoom(v3d,2.0,2.0,2.0)
#+end_src
Members of the /pasta corta/ (short pasta) branch, and originally
from southern Italy, /rigatoni/ (large ridges) are very
versitile. Their robust shape holds cream or tomato sauces well, but
/rigatoni/ are best eaten with sausages or game meat, mushrooms,
and black pepper.

** Rombi
{\center{\includegraphics[scale=0.50]{ps/v81rombi.eps}}}
#+NAME: Rombi
#+begin_src common-lisp :noweb yes
X(i,j) == _
  if ((13 <= i) and (i <= 37)) _
...
zoom(v3d,3.0,3.0,3.0)
#+end_src
A lesser-known /pasta corta/, /rombi/ (rhombuses) feature two
curled edges like /lasagna doppia riccia/, however, they are
smaller and sheared on the diagonal. Generally served with sauce and
/pastasciutta/ or in /brodo/ (in broth), according to size.

** Rotelle
{\center{\includegraphics[scale=0.50]{ps/v81rotelle.eps}}}
#+NAME: Rotelle
#+begin_src common-lisp :noweb yes
...
axes(vp,"off")
#+end_src
A modern design from the more unusual side of the /pasta corta/
(short pasta) family, /rotelle/ (small wheels) are constructed
...
** Saccottini
{\center{\includegraphics[scale=0.50]{ps/v81saccottini.eps}}}
#+NAME: Saccottini
#+begin_src common-lisp :noweb yes
...
zoom(v3d,2.0,2.0,2.0)
#+end_src
Another out-and-out member of the /pasta ripiena/ (filled pasta)
club, /saccottini/-like /fagottini/, to which they are closely
related - are made of a durum-wheat circle of dough gathered into an
irregular ball-shaped bundle. /Saccottini/ are usually stuffed
with ricotta, meat, or steamed greens.

** Sagnarelli
{\center{\includegraphics[scale=0.50]{ps/v81sagnarelli.eps}}}
#+NAME: Sagnarelli
#+begin_src common-lisp :noweb yes
...
the /pasta lunga/ (long pasta) branch. /Sagnarelli/ are
sometimes made with eggs and are generally served as {\sl
pastasciutta} with a meat /ragu/, or alongside vegetables such as
wild asparagus.

** Sagne Incannulate
{\center{\includegraphics[scale=0.50]{ps/v81sagneincannulate.eps}}}
...
rolls the rest of the /pasta lunga/ (long pasta) to form the
distinctive curl. /Sagne/ are best consumed with a thick sauce or
a traditional /ragu/.

** Scialatielli
{\center{\includegraphics[scale=0.50]{ps/v81scialatielli.eps}}}
...
scialatielli} are a rustic /pasta lunga/ (long pasta) similar in
appearance to /fettuccine/ and /tagliotelle/. When they are
made, milk and eggs can be added to the durum-wheat flour to lend it a
golden color, /Scialatielli/ are best paired with seafood, or a

** Spaccatelle
{\center{\includegraphics[scale=0.50]{ps/v81spaccatelle.eps}}}
#+NAME: Spaccatelle
#+begin_src common-lisp :noweb yes
...
zoom(v3d,2.0,2.0,2.0)
#+end_src
This noted speciality of Sicily belongs to the /pasta corta/
(short pasta) family. /Spaccatelle/ are generally elongated curves
with a concave centre, and are served as a /pastasciutta/ (pasta
boiled and drained) with a light tomato sauce or a thick meaty /ragu/.

** Spaghetti
{\center{\includegraphics[scale=0.50]{ps/v81spaghetti.eps}}}
#+NAME: Spaghetti
#+begin_src common-lisp :noweb yes
...
zoom(v3d,3.0,3.0,3.0)
#+end_src
Without a doubt, /spaghetti/ (small strings) remain the best-known
and most versatile /pasta lunga/ (long pasta) worldwide. Above all
they are known for accompanying /ragu bolognese/, a mixture
containing beef, tomato, cream, onions, and pancetta. More recently,
/spaghetti/ have become popular in a creamy /carbonara/.

** Spiralli
{\center{\includegraphics[scale=0.50]{ps/v81spiralli.eps}}}
#+NAME: Spiralli
#+begin_src common-lisp :noweb yes
...
zoom(v3d,2.5,2.5,2.5)
#+end_src
The ridged and helicoidal /spirali/ (spirals) are similar in shape
to /cavatappi/, but are slightly larger. /Spirali/ may be
served with chunky sauces as /pastasciutta/, baked /al forno/
(at the oven) with a thick cheese topping or added to salads.

** Stellette
{\center{\includegraphics[scale=0.50]{ps/v81stellette.eps}}}
#+NAME: Stellette
#+begin_src common-lisp :noweb yes
...
axes(v3d,"off")
#+end_src
A member of the /pastine minute/ (tiny pasta) family, {\sl
stellette} (little stars) are only marginally larger than both {\sl
acini di pepe} and /cuoretti/. Like all /pastine/, they are
best served in a light soup, perhaps flavored with portobello
mushrooms or peas.

** Stortini
{\center{\includegraphics[scale=0.50]{ps/v81stortini.eps}}}
#+NAME: Stortini
#+begin_src common-lisp :noweb yes
...
zoom(v3d,3.0,3.0,3.0)
#+end_src
Another /pastine minute/ (tiny pasta), /stortini/ (little
...
** Strozzapreti
{\center{\includegraphics[scale=0.50]{ps/v81strozzapreti.eps}}}
#+NAME: Strozzapreti
#+begin_src common-lisp :noweb yes
...
zoom(v3d,2.5,2.5,2.5)
#+end_src
The dough used to make /strozzapreti/ (or /strangolapreti/;
both translate to 'priest stranglers') can be prepared with assorted
flours, eggs, and even potato. /Strozzapreti/ are an ideal {\sl
pastasciutta}, and can be served with a traditional meat sauce, topped
with Parmigiano-Reggiano.

** Tagliatelle
{\center{\includegraphics[scale=0.50]{ps/v81tagliatelle.eps}}}
#+NAME: Tagliatelle
#+begin_src common-lisp :noweb yes
...
axes(vp,"off")
#+end_src
A mixture of wheat-flour and eggs, /tagliatelle/ (derived from the
Italian /tagliare/ - 'to cut') belong to the /pasta lunga/
(long pasta) family. Originally hailing from the north of Italy, {\sl
tagliatelle} are frequently served in /carbonara/ sauce, but can
also accompany seafood, or alternatively may form the basis of a {\sl
timballo} (baked pasta dish).

** Taglierini
{\center{\includegraphics[scale=0.50]{ps/v81taglierini.eps}}}
#+NAME: Taglierini
#+begin_src common-lisp :noweb yes
...
axes(vp,"off")
#+end_src
Another coiling /pasta lunga/ (long pasta), /taglierini/ are
of the same lineage as /tagliatelle/, but are substantially
narrower - almost hair-like.

** Tagliolini
{\center{\includegraphics[scale=0.50]{ps/v81tagliolini.eps}}}
#+NAME: Tagliolini
#+begin_src common-lisp :noweb yes
...
eaten as a starter with butter, soft cheese, or /al pomodoro/ (in
a light tomato sauce). Alternatively, they may be served in a chicken
broth. A versatile pasta, /tagliolini/ are also the main
ingredient for a variety of /timballo/ dishes baked /al forno/
(at the oven).

** Torchietti
{\center{\includegraphics[scale=0.50]{ps/v81torchietti.eps}}}
#+NAME: Torchietti
#+begin_src common-lisp :noweb yes
...
zoom(v3d,2.5,2.5,2.5)
#+end_src
The whorls of /torchietti/ (tiny torches) trap chunky sauces
will. Also known as /maccheroni al torchio/, they are best eaten
in a tomato sauce with larger, coarsely chopped vegetables such as
carrots, broccoli, and cauliflower.

** Tortellini
{\center{\includegraphics[scale=0.50]{ps/v81tortellini.eps}}}
#+NAME: Tortellini
#+begin_src common-lisp :noweb yes
...
axes(v3d,"off")
#+end_src
To prepare a /tortellino/, a teaspoon of meat, cheese, or
...
of the /pasta ripiena/ (filled pasta) family are traditionally
eaten in steaming soups, but are also drained and served with a local
sauce as /pastasciutta/.

** Tortiglioni
{\center{\includegraphics[scale=0.50]{ps/v81tortiglioni.eps}}}
#+NAME: Tortiglioni
#+begin_src common-lisp :noweb yes
...
zoom(v3d,2.5,2.5,2.5)
#+end_src
Another classic /pasta corta/ (short pasta), /tortiglioni/
originate from the Campania region of southern Italy. {\sl
Tortiglioni} (deriving from the Italian /torquere/ - 'to cut') are
often baked in a /timballo/ or boiled, drained and served as a
/pastasciutta/ coupled with a strong sauce of tomato, chorizo, and
black pepper.

** Trenne
{\center{\includegraphics[scale=0.50]{ps/v81trenne.eps}}}
#+NAME: Trenne
#+begin_src common-lisp :noweb yes
X(i,j) == _
  (if (i <= 33) _
...
#+end_src
A hollow triangular variety of /pasta corta/ (short pasta), {\sl
trenne} (/penne/ with a triangular cross-section) are extremely
...
penne}, /trennette/, and /ziti/.

** Tripoline
{\center{\includegraphics[scale=0.50]{ps/v81tripoline.eps}}}
#+NAME: Tripoline
#+begin_src common-lisp :noweb yes
X(i,j) == i/20.0
Y(i,j) == j/20.0
...
zoom(v3d,2.5,2.5,2.5)
#+end_src
The ribbon-like /tripoline/ are /pasta lunga/ (long pasta)
curled along one edge only. This wave gives the /tripoline/ a
...
tomato and basil, or /ragu alla napoletana/ and a sprinkling of
Pecorino Romano.

** Trofie
{\center{\includegraphics[scale=0.50]{ps/v81trofie.eps}}}
#+NAME: Trofie
#+begin_src common-lisp :noweb yes
...
zoom(v3d,3.0,3.0,3.0)
#+end_src
The Ligurian version of /gnocchi/, /trofie/ are made from a
...
paired with a simple mix of /pesto genovese/, pine nuts, salt, and
olive oil.

** Trottole
{\center{\includegraphics[scale=0.50]{ps/v81trottole.eps}}}
#+NAME: Trottole
#+begin_src common-lisp :noweb yes
...
zoom(v3d,2.0,2.0,2.0)
#+end_src
A well-formed /pasta corta/ (short pasta) comprised of rings that
curl up about a central stalk, /trottole/ are ideal for
salads. They are also delicious with pumpkin or courgette, leek, pine
nuts, and a few shavings of Parmigiano-Reggiano.

** Tubetti Rigati
{\center{\includegraphics[scale=0.50]{ps/v81tubettirigati.eps}}}
#+NAME: Tubetti Rigati
#+begin_src common-lisp :noweb yes
...
zoom(v3d,2.0,2.0,2.0)
#+end_src
The smallest members of the /pasta corta/ (short pasta) clan, {\sl
tubetti rigati} (grooved tubes) were first created in Campania,
southern Italy. When served /e fagioli/ (with beans) they create
very filling soups, but can also be served in a light /marinara/
(mariner's) sauce of tomato, basil, and onions.

** Ziti
{\center{\includegraphics[scale=0.50]{ps/v81ziti.eps}}}
#+NAME: Ziti
#+begin_src common-lisp :noweb yes
...
zoom(v3d,2.5,2.5,2.5)
#+end_src
A pasta reserved for banquets and special occasions, /ziti/
