...
\item[2] *determinate*
1. [2.1] *algebraic* -- A polynomial is defined as a summation of terms
...
functions of $x$. 
1. [2.1.1] *irrational* -- An irrational function of $x$ is a quotient
of two polynomials, one or both of which has a term (or terms) with power
$p/q$, where $p$ and $q$ are integers.
1. [2.1.2] *rational* -- A rational function of $x$ is a quotient of two
polynomials in $x$, both having only integer powers.
1. [2.1.2.1] *polynomial*
1. [2.1.2.2] *non-polynomial*
