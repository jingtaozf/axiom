...
\begin{itemize}
\item /all its direct ancestors,/
\item /any additional operations that this category supports, and/
\item /any additional axioms that the operations must satisfy./
\end{itemize}
