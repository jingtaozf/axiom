...
look as follows (the details of {\tt coerce (p[[#coerce][coerce]])}
...
{\tt coerce (p[[#coerce2][coerce2]])}, will be explained in the next
...
#+begin_example
 == FreeModule(R,FourierComponent(E)) add
    ...
    r : R
#+end_example
{\tt multiply (p[[#multiply][multiply]])} is a local function, 
