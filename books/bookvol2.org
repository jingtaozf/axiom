...
1. the construction of bounded coercion paths is a terminating
...
1. avoiding computation of unnecessary coercion paths, especially
dead end paths
1. saving already computed vertices in a hash table
