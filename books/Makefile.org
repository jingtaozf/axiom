...
${PROOFS}/acl2.lisp:
	...
	@ echo ===========================================
	@ ${BOOKS}/srctangle ${BOOKS}/bookvol5.org acl2 >${PROOFS}/acl2.lisp
	@ if [ .${ACL2} = .acl2 ] ; \
	   then \
...
${PROOFS}/coq.lisp:
	...
	@ echo ===========================================
	@ ${BOOKS}/srctangle ${BOOKS}/bookvol10.2.org coq >${PROOFS}/coq.v
	@ ${BOOKS}/srctangle ${BOOKS}/bookvol10.3.org coq >>${PROOFS}/coq.v
	@ ${BOOKS}/srctangle ${BOOKS}/bookvol10.4.org coq >>${PROOFS}/coq.v
	@ if [ .${COQ} = .coq ] ; \
	   then \
...
${PDF}/axiom.bib:
	...
	@ echo ===========================================
	@${BOOKS}/srctangle ${BOOKS}/bookvolbib.org axiom.bib \
           >${PDF}/axiom.bib
...
${PDF}/endpaper.pdf: ${IN}/endpaper.org
	@ echo ===========================================
	@ echo making ${IN}/endpaper.pdf from ${PDF}/endpaper.pamphlet
	@ echo ===========================================
	@(cd ${PDF} ; \
          ${BOOKS}/untanglec ${BOOKS}/endpaper.org > ${PDF}/endpaper.pamphlet ; \
...
${COOKBOOK}/%.pdf: ${COOKIN}/%.org
	@ echo ===========================================
	@ echo making ${COOKBOOK}/$*.pdf from ${COOKIN}/$*.pamphlet
	@ echo ===========================================
	@(cd ${COOKBOOK} ; \
	  cp ${BOOKS}/*.sty ${COOKBOOK} ; \
	  ${BOOKS}/untanglec ${COOKIN}/$*.org > ${COOKBOOK}/$*.pamphlet ; \
	  ${RM} $*.toc ; \
	  if [ -z "${NOISE}" ] ; then \
	    ${LATEX} $*.pamphlet ; \
...
${PDF}/bookvol2.pdf: ${IN}/bookvol2.org \
	...
	@(cd ${PDF} ; \
	  cp ${BOOKS}/*.sty ${PDF} ; \
	  ${BOOKS}/untanglec ${IN}/bookvol2.org > ${PDF}/bookvol2.pamphlet ; \
...
${PDF}/bookvol10.1.pdf: ${IN}/bookvol10.1.org \
      ${PDF}/axiom.bib ${PDF}/axiom.bst 
	@ echo ===========================================
	...
	@(cd ${PDF} ; \
	  cp ${BOOKS}/*.sty ${PDF} ; \
	  ${BOOKS}/untanglec ${IN}/bookvol10.1.org > ${PDF}/bookvol10.1.pamphlet ; \
	  cp ${IN}/bookheader.tex ${PDF} ; \
	  cp -pr ${IN}/ps ${PDF} ; \
	  ${RM} bookvol10.1.toc ; \
	  touch signatures.tex ; \
...
${PDF}/bookvol15.pdf: ${IN}/bookvol15.org \
      ${PDF}/axiom.bib ${PDF}/axiom.bst 
	@ echo ===========================================
	...
	@(cd ${PDF} ; \
	  cp ${BOOKS}/*.sty ${PDF} ; \
	  ${BOOKS}/untanglec ${IN}/bookvol15.org > ${PDF}/bookvol15.pamphlet ; \
	  cp ${IN}/bookheader.tex ${PDF} ; \
	  cp -pr ${IN}/ps ${PDF} ; \
	  ${RM} bookvol15.toc ; \
	  touch signatures.tex ; \
	  ...
	  if [ -z "${NOISE}" ] ; then \
	    ...
	    ${BOOKS}/srctangle ${BOOKS}/bookvol15.org defun.SigSort >SigSort.lisp ; \
...
${PDF}/%.pdf: ${IN}/%.org ${PDF}/axiom.bib ${PDF}/axiom.bst
	@ echo ===========================================
	@ echo making ${PDF}/$*.pdf from ${IN}/$*.pamphlet
	@ echo ===========================================
	@(cd ${PDF} ; \
	  cp ${BOOKS}/*.sty ${PDF} ; \
	  ${BOOKS}/untanglec ${IN}/$*.org > ${PDF}/$*.pamphlet ; \
	  cp ${IN}/bookheader.tex ${PDF} ; \
	  cp -pr ${IN}/ps ${PDF} ; \
	  ${RM} $*.toc ; \
	  touch signatures.tex ; \
...
spadedit:
	...
	@${BOOKS}/srctangle ${BOOKS}/bookvol5.org spadedit \
            >${OUT1}/SPADEDIT
