...
\verb|system:fp-output-stream| and comparing it against
\verb|*terminal-io*|'s --- an identity test below the Lisp stream
...
console if it is \verb|*terminal-io*| itself or a synonym stream
(the usual shape of \verb|*standard-output*|) resolving to it. This
