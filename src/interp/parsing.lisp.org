...
#+end_src
* META/LISP Parser Generator and Lexical Analysis Utilities (Parsing)
*** Stack
*** Token
*** Reduction
** Recursive descent parsing support routines
...
** Routines for handling lexical scanning
...
*** Manipulating the token stack and reading tokens
...
#+end_src
*** Constructing parsing procedures
#+NAME: *
#+begin_src common-lisp :noweb yes
(eval-when (eval load)
...
#+end_src
** Routines for inspecting and resetting total I/O system state
