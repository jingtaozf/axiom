...
\begin{enumerate}
\item The /origin/ is a distinguished location within a display,
...
\item The /width/ of a display is the number of columns from the
extreme left of the display (the origin, in fact) to its extreme
right.
\item The /superspan/ of a display is the number of lines it
extends above the origin
\item The /subspan/ of a display is the number of lines it extends
below the origin
\end{enumerate}
#+begin_example
             |              2
