...
1. The /width/ of a display is the number of columns from the
extreme left of the display (the origin, in fact) to its extreme
right.
1. The /superspan/ of a display is the number of lines it
extends above the origin
1. The /subspan/ of a display is the number of lines it extends
below the origin
...
the display list)
1. a function of one argument whose value is the width of its
argument
1. a function of one argument whose value is its superspan
1. a function of one argument whose value is its subspan.
