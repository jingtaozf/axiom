...
5. a function whose four arguments are an expression, the two
...
the display list)
6. a function of one argument whose value is the width of its
argument
7. a function of one argument whose value is its superspan
8. a function of one argument whose value is its subspan.
