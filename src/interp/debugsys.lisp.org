...
interpsys. See the echo lines in the *SAVESYS* block in the
...
exist. Note that these files are *hard coded* to assume they
live under */home/axiomgnu/new*. You need to do a global
search and replace if you don't place them there. We should write
lisp code to grab the *AXIOM* shell variable but since (a)
