...
** Outline of rules for integrands of the form
\[\int{(a+bx)^m}\]
See =2.1.1 (a+b x)^m.pdf=
...
\noindent*Case 2*: $m=1 => \displaystyle ax+\frac{1}{2}bx^2$
#+NAME: *
#+begin_src common-lisp :noweb yes
--S 8 of 10
...
\noindent*Case 3*: $m=-1  => \displaystyle\frac{log(a+bx)}{b}$
#+NAME: *
#+begin_src common-lisp :noweb yes
--S 9 of 10
intlinear4(A::ET, B::ET, (-1)::ET, x::SYMBOL)
