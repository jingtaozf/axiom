...
--S 55 of 131
bb1:=(a*x^2+b*x+c)^(3/2)/(3*a)-(b*(2*a*x+b))/(8*a^2)*sqrt(a*x^2+b*x+c)-_
     (b*(4*a*c-b^2))/(16*a^2)*t1.1
--R
--R   (3)
--R                        3
--R         (- 12a b c + 3b )
...
--S 56 of 131
bb2:=(a*x^2+b*x+c)^(3/2)/(3*a)-(b*(2*a*x+b))/(8*a^2)*sqrt(a*x^2+b*x+c)-_
     (b*(4*a*c-b^2))/(16*a^2)*t1.2
--R
--R   (4)
--R                                    +--------------+
--R                              +---+ |   2               +---+ +-+
...
--S 123 of 131
bb:=-(a*x^2+2*b*x+c)/(c^2*x*sqrt(a*x^2+b*x+c))+(b^2-2*a*c)/_
     (2*c^2)*t1-(3*b)/(2*c^2)*t2
--R
--R   (4)
--R                                            +--------------+
--R                      3     2   2       2   |   2
