...
--S 118 of 170
bb:=-1/(2*a^2*x^2*sqrt(a^2-x^2))+3/(2*a^4*sqrt(a^2-x^2))-_
     3/(2*a^5)*log((a+sqrt(a^2-x^2))/x)
--R
--R                              +---------+
--R              +---------+     |   2    2
--R            2 |   2    2     \|- x  + a   + a        2    3
...
--S 137 of 170
bb:=-(x*(a^2-x^2)^(5/2))/6+(a^2*x*(a^2-x^2)^(3/2))/24+_
     (a^4*x*sqrt(a^2-x^2))/16+a^6/16*asin(x/a)
--R
--R                                +---------+
--R             5      2 3     4   |   2    2      6     x
