...
[ [f(i::Float,i::Float+1.0::Float)::Float,_
  axiom(i::Float,i::Float+1.0::Float)::Float,_
  schaums(i::Float,i::Float+1.0::Float)::Float] for i in 1..4]
--R
--R   (9)
...
\ if\0 < \sec^{-1}\frac{x}{a} < \frac{\pi}{2}\\
\\
\displaystyle
x\sec^{-1}\frac{x}{a}+a\ln(x+\sqrt{x^2-a^2})
\ if\\frac{\pi}{2} < \sec^{-1}\frac{x}{a} < \pi
\end{array}
\right.
$$
#+NAME: *
...
\\
\displaystyle
\hbox{\hskip 3cm}\ if\0 < \sec^{-1}\frac{x}{a} < \frac{\pi}{2}\\
\\
\displaystyle
\frac{x^3}{3}\sec^{-1}\frac{x}{a}+\frac{ax\sqrt{x^2-a^2}}{6}
+\frac{a^3}{6}\ln(x+\sqrt{x^2-a^2})\\
...
\ if\0 < \csc^{-1}\frac{x}{a} < \frac{\pi}{2}\\
\\
\displaystyle
x\csc^{-1}\frac{x}{a}-a\ln(x+\sqrt{x^2-a^2})
\ if\-\frac{\pi}{2} < \csc^{-1}\frac{x}{a} < 0\\
\end{array}
\right.
$$
#+NAME: *
...
\\
\displaystyle
\hbox{\hskip 3cm}\ if\0 < \csc^{-1}\frac{x}{a} < \frac{\pi}{2}\\
\\
\displaystyle
\frac{x^3}{3}\sec^{-1}\frac{x}{a}-\frac{ax\sqrt{x^2-a^2}}{6}
-\frac{a^3}{6}\ln(x+\sqrt{x^2-a^2})\\
