...
u: P := 'u;
f0 := u-2;
f1:= 2*(u-1)^2+2*(x-z*x+z^2)+y^2*(x-1)^2-2*u*x+2*y*t*(1-x)*(x-z)+_
     2*u*z*t*(t-y)+u^2*t^2*(1-2*z)+2*u*t^2*(z-x)+2*u*t*y*(z-1)+_
     2*u*z*x*(y+1)+(u^2-2*u)*z^2*t^2+2*u^2*z^2+4*u*(1-u)*z+t^2*(z-x)^2;
f2:= t*(2*z+1)*(x-z)+y*(z+2)*(1-x)+u*(u-2)*t+u*(1-2*u)*z*t+u*y*(x+u-z*x-1)+_
     u*(u+1)*z^2*t;
f3:= -u^2*(z-1)^2+2*z*(z-x)-2*(x-1);
f4:= u^2+4*(z-x^2)+3*y^2*(x-1)^2-3*t^2*(z-x)^2 +3*u^2*t^2*(z-1)^2+_
     u^2*z*(z-2)+6*u*t*y*(z+x+z*x-1);
lp :=[f0,f1,f2,f3,f4];
...
y: P := 'y;
t: P := 't;
p1 := x-110*t^2+495*t^3-1320*t^4+2772*t^5-5082*t^6+7590*t^7-_
        8085*t^8+5555*t^9-2189*t^10+374*t^11;
p2 :=  y-22*t+110*t^2-330*t^3+1848*t^5-3696*t^6+3300*t^7-1650*t^8+_
...
ls : List Symbol := _
      reverse [x10,x11,x12,x13,x21,x22,x23,x30,x101,x102,x103,x104,x105];
V := OVAR(ls);
R := Integer;
E := IndexedExponents V;
P := NSMP(R, V);
...
p2 := 8*U5*u6 + 8*U5*u5 + 8*U4*u6 +8*U4*u5 + 8*U4*u4 + 8*U3*u6 + 8*U3*u5 + _
      8*U3*u4 + 8*U3*u3 + 8*U2*u6 +8*U2*u5 + 8*U2*u4 + 8*U2*u3 + 8*U2*u2 -13;
p3 := 2*U6 + 2*U5 + 2*U4 + 2*U3 +2*U2 + 1;
p4 := 8*U6*u5 + 8*U6*u4 + 8*U6*u3 + 8*U6*u2 + 8*U5*u5 + 8*U5*u4 +8*U5*u3 + _
      8*U5*u2 + 8*U4*u4 + 8*U4*u3 + 8*U4*u2 + 8*U3*u3 + 8*U3*u2 +8*U2*u2 -13;
p6 := U2*u2 -1;
p7 := U3*u3 -1;
p8 := U4*u4 -1;
p9 := U5*u5 -1;
