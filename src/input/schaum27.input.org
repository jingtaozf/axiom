...
--S 63 of 84
bb:=1/(a*sqrt(p^2+q^2))*log((q*%e^(a*x)+p-sqrt(p^2+q^2))/(q*%e^(a*x)+_
    p+sqrt(p^2+q^2)))
--R
--R               +-------+
--R               | 2    2        a x
...
--S 71 of 84
bb2:=1/(2*a*p*sqrt(p^2-q^2))*log((p+sqrt(p^2-q^2)*tanh(a*x))/_
     (p-sqrt(p^2-q^2)*tanh(a*x)))
--R
--R                        +---------+
--R                        |   2    2
--R            - tanh(a x)\|- q  + p   - p
...
--S 77 of 84
bb:=1/(2*a*p*sqrt(p^2+q^2))*log((p+sqrt(p^2+q^2)*tanh(a*x))/_
    (p-sqrt(p^2+q^2)*tanh(a*x)))
--R
--R                        +-------+
--R                        | 2    2
