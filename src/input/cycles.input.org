...
#+end_src
The function =elementary n= is the nth elementary symmetric function.
#+NAME: *
#+begin_src common-lisp :noweb yes
--S 5 of 46
elementary 7
...
#+end_src
The function =alternating n= is the cycle index of the alternating group
...
#+end_src
The function =cyclic n= is the cycle index of the cyclic group
#+NAME: *
#+begin_src common-lisp :noweb yes
--S 7 of 46
cyclic 7
...
#+end_src
The function =dihedral n= is the cycle index of the dihedral group
#+NAME: *
#+begin_src common-lisp :noweb yes
--S 8 of 46
dihedral 7
...
#+end_src
The function =graphs n= is the cycle index of the group of 
...
first from =a a a b b c=, second from =d d e e f g=.
#+NAME: *
#+begin_src common-lisp :noweb yes
--S 12 of 46
...
value required of $s_i$, and then evaluating =eval(f,cycleindex)=
#+NAME: *
#+begin_src common-lisp :noweb yes
--S 27 of 46
