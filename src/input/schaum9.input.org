...
--S 79 of 110
bb:=-1/(2*a^2*x^2*sqrt(x^2+a^2))-3/(2*a^4*sqrt(x^2+a^2))+_
     3/(2*a^5)*log((a+sqrt(x^2+a^2))/x)
--R
--R                          +-------+
--R            +-------+     | 2    2
--R          2 | 2    2     \|x  + a   + a        2    3
...
--S 91 of 110
bb:=(x*(x^2+a^2)^(5/2))/6-(a^2*x*(x^2+a^2)^(3/2))/24-_
    (a^4*x*sqrt(x^2+a^2))/16-a^6/16*log(x+sqrt(x^2+a^2))
--R
--R                  +-------+                              +-------+
--R            6     | 2    2            5      2 3     4   | 2    2
