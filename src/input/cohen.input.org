...
#+NAME: domain CID CohenIdentifier
#+begin_src common-lisp :noweb yes
...
#+NAME: domain CFUNC CohenFunction
#+begin_src common-lisp :noweb yes
...
#+NAME: domain CREP CohenRepresentation
#+begin_src common-lisp :noweb yes
...
#+NAME: domain CPOLY CohenPolynomial
#+begin_src common-lisp :noweb yes
...
#+NAME: package CMANIP CohenManipulations
#+begin_src common-lisp :noweb yes
...
<<domain CINT CohenInteger>>
<<domain CID CohenIdentifier>>
<<domain COP CohenOperator>>
<<domain CFUNC CohenFunction>>
<<domain CNODE CohenNode>>
<<domain CREP CohenRepresentation>>
<<domain CPOLY CohenPolynomial>>
<<package CMANIP CohenManipulations>>
#+end_src
