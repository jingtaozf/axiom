...
function Inverse Secant (noted =asec=) is defined by
...
*** ASC.2.1 Asymptotic expansion at $-1$
**** ASC.2.1.1 First terms

$$
\begin{array}{cc}
& asec(x)\approx (\pi...) + \sqrt{x + 1} 
\left(-i\sqrt{2} - \frac{5 i}{12} (x + 1) \sqrt{2} - 
\frac{43 i}{160} (x + 1)^{2} \sqrt{2}\right.  \\
& {} {}- \frac{177 i}{896} (x + 1)^{3} \sqrt{2} - 
\frac{2867 i}{18432} (x + 1)^{4} \sqrt{2} -  \\
& {} {}\frac{11531 i}{90112} (x + 1)^{5} \sqrt{2} - 
\frac{92479 i}{851968} (x + 1)^{6} \sqrt{2} -  \\
& \left. {} {}\frac{74069 i}{786432} (x + 1)^{7} \sqrt{2} - 
\frac{11857475 i}{142606336} (x + 1)^{8} \sqrt{2}...\right).
\end{array}
$$

*** ASC.2.1 Asymptotic expansion at $0$
**** ASC.2.2.1 First terms

$$
\begin{array}{cc}
& asec(x)\approx  \\
& {} {}\left(i ln(2) + \frac{i}{4} x^{2} + 
\frac{3 i}{32} x^{4} + \frac{5 i}{96} x^{6} + 
\frac{35 i}{1024} x^{8} + i ln(x)...\right).
\end{array}
$$

*** ASC.2.3 Asymptotic expansion at $1$
**** ASC.2.3.1 First terms
...
& {} {}\frac{177 \sqrt{2} (x - 1)^{3}}{896} + 
\frac{2867 \sqrt{2} (x - 1)^{4}}{18432} - 
\frac{11531 \sqrt{2} (x - 1)^{5}}{90112} +  \\
& {} {}\frac{92479 \sqrt{2} (x - 1)^{6}}{851968} - 
\frac{74069 \sqrt{2} (x - 1)^{7}}{786432} +  \\
& {} {}\frac{11857475 \sqrt{2} (x - 1)^{8}}{142606336} - 
\frac{47442055 \sqrt{2} (x - 1)^{9}}{637534208} +  \\
& {} {}\frac{126527543 \sqrt{2} (x - 1)^{10}}{1879048192} - 
\frac{1518418695 \sqrt{2} (x - 1)^{11}}{24696061952} +  \\
& {} {}\frac{24295375159 \sqrt{2} (x - 1)^{12}}{429496729600} - 
\frac{97182800711 \sqrt{2} (x - 1)^{13}}{1855425871872} +  \\
& \left. {} {}\frac{777467420263 
\sqrt{2} (x - 1)^{14}}{15942918602752} - 
\frac{3109879375897 \sqrt{2} (x - 1)^{15}}{68169720922112}...\right).
\end{array}
$$
...
As implemented within Axiom the =asec= function is
