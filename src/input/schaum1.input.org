...
#+begin_src common-lisp :noweb yes
--S 12 of 108
bb:=(a*x+b)^3/(3*a^4)-(3*b*(a*x+b)^2)/(2*a^4)+(3*b^2*(a*x+b))/a^4-_
    (b^3/a^4)*log(a*x+b)
--R
--R            3                 3 3     2   2       2       3
...
--S 55 of 108
bb:=-(a*x+b)^2/(2*b^4*x^2)+(3*a*(a*x+b))/(b^4*x)-(a^3*x)/(b^4*(a*x+b))-_
     ((3*a^2)/b^4)*log((a*x+b)/x)
--R
...
--S 103 of 108
bb:=(a*x+b)^(n+3)/((n+3)*a^3)-(2*b*(a*x+b)^(n+2))/_
    ((n+2)*a^3)+(b^2*(a*x+b)^(n+1))/((n+1)*a^3)
--R
--R   (2)
--R         2                   n + 3          2                      n + 2
