...
\int{csch^3~{ax}}~dx$}
$$\int{csch^3~{ax}}=
-\frac{csch~{ax}\coth{ax}}{2a}-\frac{1}{2a}\ln\tanh\frac{ax}{2}
$$
#+NAME: *
#+begin_src common-lisp :noweb yes
)clear all
...
\int{csch^n~{ax}~{\coth{ax}}}~dx$}
$$\int{csch~^n{ax}~{\coth{ax}}}=
-\frac{csch~^{n}{ax}}{na}
$$
#+NAME: *
#+begin_src common-lisp :noweb yes
...
\int{\frac{dx}{q+p~csch~{ax}}}~dx$}
$$\int{\frac{1}{q+p~csch~{ax}}}=
...
\int{csch^n~{ax}}~dx$}
$$\int{csch^n~{ax}}=
\frac{-csch^{n-2}~{ax}~\coth{ax}}{a(n-1)}
-\frac{n-2}{n-1}\int{csch^{n-2}~{ax}}
$$
#+NAME: *
#+begin_src common-lisp :noweb yes
)clear all
