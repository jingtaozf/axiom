...
#+TITLE: The Math Behind Bitcoin[cite:@1]
...
7. Calculate the point. This is done in the same manner as determining
...
10. Our signature is the pair (r, s) = (62, 47).
...
11. Verify that $r$ and $s$ are between $1$ and $n - 1$.
12. Calculate $w = s^{-1} mod n$
13. Calculate $u = z * w mod n$
14. Calculate $v = r * w mod n$
15. Calculate the point $(x, y) = uG + vQ$
16. Verify that $r = x mod n$. The signature is invalid if it is not.
...
17. Verify that r and s are between 1 and n - 1. Check and check.
...
\bibitem[1]{1} 
=blog.chain.com/post/95218566791/the-math-behind-bitcoin=
\bibitem[2]{2} 
=arstechnica.com/gaming/2010/12/ps3-hacked-through-poor-implementation=
=-of-cryptography=
\bibitem[3]{3}
=perso-univ-rennes1.fr/sylvain.duquesne/master/standards/sec2_final.pdf=
\bibitem[4]{4}
=it.slashdot.org/story/13/09/11/1224252/are-the-nist-standard-elliptic-curves-back-doored=
\bibitem[5]{5}
=en.bitcoin.it/wiki/Secp256k1=
\bibitem[6]{6}
=kukuruku.co/hub/infosec/backdoor-in-a-public-rsa-key=
\bibitem[7]{7}
=github.com/bitcoin/secp256k1=
\bibitem[8]{8}
=crypto.stackexchange.com/questions/784/are-there-any-secp256k1-=
=ecdsa-test-examples-available=
...
\bibitem[11]{11}
=coinmagazine.com/7781/satoshis-genius-unexpected-ways-in-which-=
