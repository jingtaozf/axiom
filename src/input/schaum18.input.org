...
--S 88 of 127
bb2:=1/(a*sqrt(q^2-p^2))*log((tan(1/2*a*x)+sqrt((q+p)/(q-p)))/_
     (tan(1/2*a*x)-sqrt((q+p)/(q-p))))
--R
--R               +-----+
--R               |q + p        a x
--R            -  |-----  - tan(---)
...
--S 111 of 127
bb2:=1/(2*a*p*sqrt(q^2-p^2))*log((p*tan(a*x)-sqrt(q^2-p^2))/_
     (p*tan(a*x)+sqrt(q^2-p^2)))
--R
--R               +-------+
--R               | 2    2
--R            - \|q  - p   + p tan(a x)
