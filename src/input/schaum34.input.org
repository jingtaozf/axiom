...
#+LATEX: \setlength{\textwidth}{405pt}
#+LATEX: \begin{document}
#+TITLE: schaum34.input
#+AUTHOR: Timothy Daly
...
\begin{array}{l}
\displaystyle
x\cosh^{-1}(x/a)-\sqrt{x^2-a^2}, \cosh^{-1}\frac{x}{a} > 0\\
\\
\displaystyle
x\cosh^{-1}(x/a)+\sqrt{x^2-a^2}, \cosh^{-1}\frac{x}{a} < 0\\
\end{array}
...
\\
\displaystyle
\hbox{\hskip 2cm}+if\\cosh^{-1}(x/a)>0,
 -if\\cosh^{-1}(x/a)<0,
\end{array}
$$
#+NAME: *
...
\\
\displaystyle
\hbox{\hskip 1cm}-if\\cosh^{-1}(x/a)>0,
 +if\\cosh^{-1}(x/a)<0,
\end{array}
$$
#+NAME: *
...
\int{sech^{-1}\frac{x}{a}}~dx$}
$$\int{sech^{-1}\frac{x}{a}}=
\left\{
\begin{array}{l}
\displaystyle
x~sech^{-1}(x/a)+a\sin^{-1}(x/a), sech^{-1}(x/a)>0\\
\\
\displaystyle
x~sech^{-1}(x/a)-a\sin^{-1}(x/a), sech^{-1}(x/a)<0\\
\end{array}
...
\int{x~sech^{-1}\frac{x}{a}}~dx$}
$$\int{x~sech^{-1}\frac{x}{a}}=
\left\{
\begin{array}{l}
\displaystyle
\frac{1}{2}x^2~sech^{-1}(x/a)-\frac{1}{2}a\sqrt{a^2-x^2},
 sech^{-1}(x/a)>0\\
\\
\displaystyle
\frac{1}{2}x^2~sech^{-1}(x/a)+\frac{1}{2}a\sqrt{a^2-x^2},
...
\int{\frac{sech^{-1}(x/a)}{x}}~dx$}
$$\int{\frac{sech^{-1}(x/a)}{x}}=
\left\{
\begin{array}{l}
\displaystyle
...
\int{csch^{-1}\frac{x}{a}}~dx$}
$$\int{csch^{-1}\frac{x}{a}}=
x~csch^{-1}\frac{x}{a}\pm a\sinh^{-1}\frac{x}{a}
 +if\x>0, -if\x<0
$$
#+NAME: *
#+begin_src common-lisp :noweb yes
...
\int{x~csch^{-1}\frac{x}{a}}~dx$}
$$\int{x~csch^{-1}\frac{x}{a}}=
\frac{x^2}{2}~csch^{-1}\frac{x}{a}\pm \frac{a\sqrt{x^2+a^2}}{2}
 +if\x>0, -if\x<0
$$
#+NAME: *
#+begin_src common-lisp :noweb yes
...
\int{\frac{csch^{-1}(x/a)}{x}}~dx$}
$$\int{\frac{csch^{-1}(x/a)}{x}}=
\left\{
\begin{array}{lr}
\displaystyle
...
\int{x^m~sech^{-1}\frac{x}{a}}~dx$}
$$\int{x^m~sech^{-1}\frac{x}{a}}=
\left\{
\begin{array}{lr}
\displaystyle
\frac{x^{m+1}}{m+1}~sech^{-1}\frac{x}{a}
...
\int{x^m~csch^{-1}\frac{x}{a}}~dx$}
$$\int{x^m~csch^{-1}\frac{x}{a}}=
\frac{x^{m+1}}{m+1}~csch^{-1}\frac{x}{a}
