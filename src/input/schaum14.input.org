...
--S 16 of 39
bb:=-1/(a^3*x)-1/(6*a^4)*log((x^2-a*x+a^2)/(x+a)^2)-1/(a^4*sqrt(3))*_
     atan((2*x-a)/(a*sqrt(3)))
--R
--R                  2          2                        +-+
--R                 x  - a x + a        +-+     (2x - a)\|3
...
--S 20 of 39
bb:=x/(3*a^3*(x^3+a^3))+1/(9*a^5)*log((x+a)^2/(x^2-a*x+a^2))+_
    2/(3*a^5*sqrt(3))*atan((2*x-a)/(a*sqrt(3)))
--R
--R   (2)
--R                 2           2                                 +-+
...
--S 24 of 39
bb:=x^2/(3*a^3*(x^3+a^3))+1/(18*a^4)*log((x^2-a*x+a^2)/(x+a)^2)+_
    1/(3*a^4*sqrt(3))*atan((2*x-a)/(a*sqrt(3)))
--R
--R   (2)
--R                  2          2                                 +-+
