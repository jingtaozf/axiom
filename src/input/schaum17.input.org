...
--S 85 of 136
bb2:=1/(a*sqrt(q^2-p^2))*log((p*tan((a*x)/2)+q-sqrt(q^2-p^2))/_
     (p*tan((a*x)/2)+q+sqrt(q^2-p^2)))
--R
--R               +-------+
--R               | 2    2          a x
--R            - \|q  - p   + p tan(---) + q
...
--S 112 of 136
tanrule2:RewriteRule(INT,COMPLEX(INT),EXPR(COMPLEX(INT))):=rule(tan(a) == _
  sin(a)/cos(a))
--R
--R                  sin(a)
--R   (8)  tan(a) == ------
...
--S 118 of 136
bb2:=1/(2*a*p*sqrt(q^2-p^2))*log((sqrt(q^2-p^2)*tan(a*x)+p)/_
     (sqrt(q^2-p^2)*tan(a*x)-p))
--R
--R                     +-------+
--R                     | 2    2
--R            tan(a x)\|q  - p   + p
...
--S 129 of 136
rootrule4a:RewriteRule(INT,COMPLEX(INT),EXPR(COMPLEX(INT))):=_
  rule(sqrt(p^2-q^2)==sqrt(p-q)*sqrt(q+p))
--R
--R          +---------+
--R          |   2    2      +-------+ +-----+
--R   (14)  \|- q  + p   == \|- q + p \|q + p
