...
=8.\ \ \ \ \ Exports\ ==\ with=\newline
=9.\ \ \ \ \ \ \ elt:\ (\$,QueryEquation)\ ->\ \$=\newline
=10.\ \ \ \ \ \ elt:\ (\$,\ Symbol)\ ->\ DataList\ String=\newline
=11.\ \ \ \ \ \ "+":\ (\$,\$)\ ->\ \$=\newline
=12.\ \ \ \ \ \ "-":\ (\$,\$)\ ->\ \$=\newline
=13.\ \ \ \ \ \ display:\ \$\ ->\ Void=\newline
=14.\ \ \ \ \ \ fullDisplay:\ \$\ ->\ Void=\newline
=15.\ \ \ \ \ \ fullDisplay:\ (\$,PI,PI)\ ->\ Void=\newline
=16.\ \ \ \ \ \ coerce:\ \$\ ->\ OutputForm=\newline
...
cards of =db= such that the field part of the index
...
right-hand sides.
The =Implementation= part uses \pspadtype{Record} for a
