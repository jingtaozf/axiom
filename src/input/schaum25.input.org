...
\\
&\hbox{\hskip 5cm}{\rm\ if\ }n=positive integer
\end{array}
$$
#+NAME: *
#+begin_src common-lisp :noweb yes
...
--S 33 of 40
bb:=(x*%e^(a*x)*(a*sin(b*x)-b*cos(b*x)))/(a^2+b^2)-(%e^(a*x)*((a^2-b^2)*_
    sin(b*x)-2*a*b*cos(b*x)))/(a^2+b^2)^2
--R
--R   (2)
--R        2    3      2    2   a x                3    2                     a x
--R   ((a b  + a )x + b  - a )%e   sin(b x) + ((- b  - a b)x + 2a b)cos(b x)%e
...
--S 36 of 40
bb:=(x*%e^(a*x)*(a*cos(b*x)+b*sin(b*x)))/(a^2+b^2)-(%e^(a*x)*((a^2-b^2)*_
    cos(b*x)+2*a*b*sin(b*x)))/(a^2+b^2)^2
--R
--R   (2)
--R      3    2             a x                2    3      2    2           a x
--R   ((b  + a b)x - 2a b)%e   sin(b x) + ((a b  + a )x + b  - a )cos(b x)%e
