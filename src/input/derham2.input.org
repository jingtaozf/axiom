...
$\alpha\land\star\beta=\langle\alpha,beta\rangle\eta, \eta=\sqrt{|g|}dx_1\land...\land dx_n$
#+NAME: *
#+begin_src common-lisp :noweb yes
--S 37 of 64
...
#+end_src
*Minkowski spacetime* with metric signature $(+---)$ and
coordinates (t,x,y,z)

Checking =http://en.wikipedia.org/wiki/Hodge\_dual=
#+NAME: *
#+begin_src common-lisp :noweb yes
--S 53 of 64
