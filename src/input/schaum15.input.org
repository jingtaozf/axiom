...
--S 2 of 65
bb:=1/(4*a^3*sqrt(2))*log((x^2+a*x*sqrt(2)+a^2)/(x^2-a*x*sqrt(2)+a^2))-_
    1/(2*a^3*sqrt(2))*atan((a*x*sqrt(2))/(x^2-a^2))
--R
--R                      +-+    2    2                  +-+
--R         +-+    - a x\|2  - x  - a       +-+     a x\|2
--R        \|2 log(-------------------) - 2\|2 atan(-------)
...
--S 14 of 65
bb:=1/(4*a*sqrt(2))*log((x^2-a*x*sqrt(2)+a^2)/(x^2+a*x*sqrt(2)+a^2))-_
    1/(2*a*sqrt(2))*atan((a*x*sqrt(2))/(x^2-a^2))
--R
--R                      +-+    2    2                  +-+
--R         +-+    - a x\|2  + x  + a       +-+     a x\|2
--R        \|2 log(-------------------) - 2\|2 atan(-------)
...
--S 29 of 65
bb:=-1/(a^4*x)-1/(4*a^5*sqrt(2))*log((x^2-a*x*sqrt(2)+a^2)/(x^2+a*x*sqrt(2)+_
     a^2))+1/(2*a^5*sqrt(2))*atan((a*x*sqrt(2))/(x^2-a^2))
--R
--R                         +-+    2    2                   +-+
--R            +-+    - a x\|2  + x  + a        +-+     a x\|2
