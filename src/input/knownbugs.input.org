...
#+end_src
*** bug6: turn off loading messages
#+begin_example
...
#+end_src
*** bug7: axiom.input should have a period prefix
#+begin_example
...
#+end_src
*** bug8: 325 Severe bug in normalize\$EFSTRUC
